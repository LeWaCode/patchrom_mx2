...
.method private freeExt1Records(Lcom/android/internal/telephony/gsm/UsimPhoneBookManagerEx;Ljava/util/Vector;Ljava/lang/String;)Z
    ...
    const-string v8, "usim contact: free EFext1 record, EFext1 = "
    ...
    .line 1091
    const-string v6, "usim contact: free EFext1 record, error of writeEfRecord"
    ...
    const-string v8, "usim contact: free EFext1 record, success"
...
.method private internalUpdateAdnRecord(IILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;Ljava/lang/String;)Z
    ...
    const-string v8, "usim contact: no free space for new email record, so can\'t update a contact"
    ...
    .line 1149
    const-string v4, "usim contact: no free space for new number and additional number, so can\'t update a contact"
...
.method private writeAdNumberWithExt1RecordChain(Lcom/android/internal/telephony/gsm/UsimPhoneBookManagerEx;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string v19, "usim contact: free EFanr record, EFanr = "
    ...
    const-string v19, "usim contact: free EFadn record, error of writeEfRecord"
    ...
    const-string v19, "usim contact: free EFadn record, success"
    ...
    const-string v19, "usim contact: write EFanr record, EFanr = "
    ...
    .line 1350
    const-string v9, "usim contact: write EFanr record, error of writeEfRecord"
    ...
    .line 1338
    const-string v9, "usim contact: write EFanr record, error of no free ext1 record"
    ...
    const-string v19, "usim contact: write EFanr record, success"
    ...
    const-string v19, "usim contact: write EFext1 record, EFext1 = "
    ...
    .line 1382
    const-string v9, "usim contact: write EFext1 record, error of writeEfRecord"
    ...
    const-string v19, "usim contact: write EFext1 record, success"
...
.method private writeEfRecord(II[BLjava/lang/String;)Z
    ...
    .line 1505
    const-string v0, "usim contact: parameter data is null for writeEfRecord"
...
.method private writeIapAndEmailRecord(Lcom/android/internal/telephony/gsm/UsimPhoneBookManagerEx;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    .line 1224
    const-string v12, "usim contact: write EFemail record, error of no free EFemail record"
    ...
    const-string v13, "usim contact: write EFiap record, EFiap = "
    ...
    .line 1235
    const-string v12, "usim contact: write EFiap record, error of writeEfRecord"
    ...
    const-string v13, "usim contact: write EFiap record, success"
    ...
    const-string v13, "usim contact: write EFemail record, EfEmail = "
    ...
    .line 1249
    const-string v12, "usim contact: write EFemail record, error of writeEfRecord"
    ...
    const-string v13, "usim contact: write EFemail record, success"
    ...
    const-string v13, "usim contact: free EFiap record, EFiap = "
    ...
    .line 1264
    const-string v12, "usim contact: free EFiap record, error of writeEfRecord"
    ...
    const-string v13, "usim contact: free EFiap record, success"
    ...
    const-string v13, "usim contact: free EFemail record, EFemail = "
    ...
    .line 1279
    const-string v12, "usim contact: free EFemail record, error of writeEfRecord"
    ...
    const-string v13, "usim contact: free EFemail record, success"
...
.method private writeNumberWithExt1RecordChain(Lcom/android/internal/telephony/gsm/UsimPhoneBookManagerEx;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    const-string v18, "usim contact: free EFadn record, EFadn = "
    ...
    .line 1419
    const-string v4, "usim contact: free EFadn record, error of writeEfRecord"
    ...
    const-string v18, "usim contact: free EFadn record, success"
    ...
    const-string v18, "usim contact: write EFadn record, EFadn = "
    ...
    .line 1456
    const-string v4, "usim contact: write EFadn record, error of writeEfRecord"
    ...
    .line 1444
    const-string v4, "usim contact: write EFadn record, error of no free ext1 record"
    ...
    const-string v18, "usim contact: write EFadn record, success"
    ...
    const-string v18, "usim contact: write EFext1 record, EFext1 = "
    ...
    .line 1489
    const-string v4, "usim contact: write EFext1 record, error of writeEfRecord"
    ...
    const-string v18, "usim contact: write EFext1 record, success"
