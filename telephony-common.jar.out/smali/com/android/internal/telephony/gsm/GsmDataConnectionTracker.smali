...
.method private buildWaitingApns(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->shouldUsePreferred()Z
    ...
    invoke-virtual {v8, p1}, Lcom/android/internal/telephony/ApnSetting;->canHandleType(Ljava/lang/String;)Z
...
.method private cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;)V
    ...
    invoke-virtual {p0, v6, p2}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
.method private ignoreUserDataEnableForSpecialApn(Lcom/android/internal/telephony/ApnContext;)Z
    .locals 1
    .parameter "apnCtx"
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isSpecialApn(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isSpecialApnReady()Z
...
.method private isSpecialApn(Lcom/android/internal/telephony/ApnContext;)Z
    .locals 2
    .parameter "apnContext"
...
.method private isSpecialApnConnected()Z
    .locals 4
    ...
    .line 2613
    .local v0, apnt:Lcom/android/internal/telephony/ApnContext;
    ...
    .line 2620
    .end local v0           #apnt:Lcom/android/internal/telephony/ApnContext;
    :goto_0
    return v2
...
.method private isSpecialApnReady()Z
    .locals 4
    ...
    .line 2559
    .local v1, mmsApnContext:Lcom/android/internal/telephony/ApnContext;
    iget-object v2, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mApnContexts:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 2560
    .local v0, dmApnContext:Lcom/android/internal/telephony/ApnContext;
    if-eqz v1, :cond_0
...
.method private mutexSpecialApnAndOthersWhenSetEnabled(II)V
    .locals 7
    .parameter "apnId"
    .parameter "enabled"
    ...
    .line 2627
    .local v0, apnContextTmp:Lcom/android/internal/telephony/ApnContext;
    invoke-virtual {v0}, Lcom/android/internal/telephony/ApnContext;->getApnType()Ljava/lang/String;
    ...
    const-string v5, "test cleanUpConnection for mute "
    ...
    .line 2634
    invoke-direct {p0, v6, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->cleanUpConnection(ZLcom/android/internal/telephony/ApnContext;)V

    goto :goto_0

    .line 2639
    .end local v0           #apnContextTmp:Lcom/android/internal/telephony/ApnContext;
    ...
    .line 2641
    .restart local v0       #apnContextTmp:Lcom/android/internal/telephony/ApnContext;
    const-string v4, "dm"
    ...
    .line 2642
    const-string v4, "test cleanUpAllConnection for dm"
...
.method private restoreDefaultApnForSpcialApn(Lcom/android/internal/telephony/ApnContext;)Z
    .locals 4
    .parameter "apnContext"
...
.method private setupDataOnReadyApns(Ljava/lang/String;)V
    ...
    .line 706
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isSpecialApnConnected()Z
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->trySetupSpeicalApn(Lcom/android/internal/telephony/ApnContext;)Lcom/android/internal/telephony/ApnContext;
...
.method private shouldUsePreferred()Z
    .locals 4
    ...
    .line 2657
    .local v1, usePreferred:Z
    :goto_0
    return v1

    .line 2652
    .end local v1           #usePreferred:Z
    :cond_0
    const/4 v1, 0x0
    ...
    .restart local v1       #usePreferred:Z
    goto :goto_0
.end method
...
.method private trySetupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->getAnyDataEnabled(Lcom/android/internal/telephony/ApnContext;)Z
...
.method private trySetupSpeicalApn(Lcom/android/internal/telephony/ApnContext;)Lcom/android/internal/telephony/ApnContext;
    .locals 5
    .parameter "discApn"
    ...
    .line 2587
    .local v0, apnToSetup:Lcom/android/internal/telephony/ApnContext;
    ...
    .line 2588
    .local v1, apnt:Lcom/android/internal/telephony/ApnContext;
    invoke-virtual {v1}, Lcom/android/internal/telephony/ApnContext;->isReady()Z
    ...
    const-string v4, "try delayed apn = "
    ...
    .line 2597
    .end local v1           #apnt:Lcom/android/internal/telephony/ApnContext;
    :cond_2
    if-eqz v0, :cond_3
    ...
    iget-object v3, v3, Lcom/android/internal/telephony/DataConnectionAc;->dataConnection:Lcom/android/internal/telephony/DataConnection;
...
.method public getAnyDataEnabled()Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->getAnyDataEnabled(Lcom/android/internal/telephony/ApnContext;)Z
...
.method public getAnyDataEnabled(Lcom/android/internal/telephony/ApnContext;)Z
    .locals 5
    .parameter "apnCtx"
    ...
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->ignoreUserDataEnableForSpecialApn(Lcom/android/internal/telephony/ApnContext;)Z
...
.method public getPreState(Ljava/lang/String;)Lcom/android/internal/telephony/DctConstants$State;
    .locals 2
    .parameter "apnType"
    ...
    .line 434
    invoke-virtual {v0}, Lcom/android/internal/telephony/ApnContext;->getPreState()Lcom/android/internal/telephony/DctConstants$State;
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->shouldUsePreferred()Z
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    invoke-virtual {v0, v4}, Lcom/android/internal/telephony/ApnContext;->setState(Lcom/android/internal/telephony/DctConstants$State;)V
    ...
    .line 2002
    :cond_2
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isSpecialApn(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-direct {p0, v4}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->retryAfterDisconnected(Ljava/lang/String;)Z
    ...
    .line 2021
    .local v1, apnToSetup:Lcom/android/internal/telephony/ApnContext;
    if-eqz v3, :cond_6

    .line 2022
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->trySetupSpeicalApn(Lcom/android/internal/telephony/ApnContext;)Lcom/android/internal/telephony/ApnContext;
    ...
    .line 2028
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->restoreDefaultApnForSpcialApn(Lcom/android/internal/telephony/ApnContext;)Z

    .line 2042
    .end local v1           #apnToSetup:Lcom/android/internal/telephony/ApnContext;
    :cond_5
    :goto_1
    if-eqz v2, :cond_0
    ...
    .line 2030
    .restart local v1       #apnToSetup:Lcom/android/internal/telephony/ApnContext;
    :cond_6
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->trySetupSpeicalApn(Lcom/android/internal/telephony/ApnContext;)Lcom/android/internal/telephony/ApnContext;
...
.method protected onEnableApn(II)V
    ...
    .line 1725
    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->mutexSpecialApnAndOthersWhenSetEnabled(II)V
...
.method protected onTrySetupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    const-string v3, "onTrySetupData: apnContext="
    ...
    .line 1745
    const-string v2, "onTrySetupData: delay for special"
    ...
    .line 1756
    .local v0, state:Lcom/android/internal/telephony/DctConstants$State;
    sget-object v2, Lcom/android/internal/telephony/DctConstants$State;->IDLE:Lcom/android/internal/telephony/DctConstants$State;
    ...
    const-string v3, "onTrySetupData: overallState is "
