...
.method static synthetic access$1100(Lcom/android/server/MountService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method public static buildObbPath(Ljava/lang/String;IZ)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Landroid/os/Environment$UserEnvironment;->getExternalStorageDirectoryMzInternal()Ljava/io/File;
...
.method private createEmulatedVolumeForUserLocked(Landroid/os/UserHandle;)V
    ...
    invoke-virtual {v1}, Landroid/os/Environment$UserEnvironment;->getExternalStorageDirectoryMzInternal()Ljava/io/File;
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    :cond_0
    :goto_0
    iget-boolean v5, p0, Lcom/android/server/MountService;->mPendingAutoInstall:Z
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    .line 1122
    const-string v5, "externalvolumechecking"

    invoke-direct {p0, p1, v5}, Lcom/android/server/MountService;->updateExternalVolumeState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "action.external.volume.mounted"

    invoke-direct {v1, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1126
    .restart local v1       #in:Landroid/content/Intent;
    const-string v5, "externalvolumemounted"
    ...
    .end local v1           #in:Landroid/content/Intent;
    const-string v5, "action.external.volume.unmounting"

    invoke-direct {v1, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1131
    .restart local v1       #in:Landroid/content/Intent;
    const-string v5, "externalvolumeunmounting"
    ...
    iput-object v5, p0, Lcom/android/server/MountService;->mUnmountDisk:Landroid/os/storage/DiskInfo;

    .line 1139
    new-instance v1, Landroid/content/Intent;

    .end local v1           #in:Landroid/content/Intent;
    const-string v5, "action.external.volume.idle"

    invoke-direct {v1, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1140
    .restart local v1       #in:Landroid/content/Intent;
    const-string v5, "externalvolumeidle"
...
.method public onEvent(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string v26, "VoldResponseCode.ExternalVolumeDiskInserted"
    ...
    new-instance v13, Landroid/os/storage/DiskInfo;
    ...
    invoke-direct {v13, v0, v1}, Landroid/os/storage/DiskInfo;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 917
    .local v13, info:Landroid/os/storage/DiskInfo;
    const-string v25, "MountService"
    ...
    .line 919
    const-string v25, "externalvolumeinserted"
    ...
    .end local v13           #info:Landroid/os/storage/DiskInfo;
    ...
    const-string v26, "VoldResponseCode.ExternalVolumeDiskRemoed"
    ...
    .line 925
    .restart local v13       #info:Landroid/os/storage/DiskInfo;
    iget-object v0, v13, Landroid/os/storage/DiskInfo;->mDiskName:Ljava/lang/String;

    move-object/from16 v25, v0

    const-string v26, "externalvolumeremoved"
    ...
    const-string v25, "action.external.volume.removed"
    ...
    .line 933
    .restart local v21       #removeIndex:I
    const-string v25, "MountService"
    ...
    const-string v27, "info.mDiskName "
    ...
    iput-object v13, v0, Lcom/android/server/MountService;->mUnmountDisk:Landroid/os/storage/DiskInfo;
    ...
    invoke-virtual {v13, v0}, Landroid/os/storage/DiskInfo;->findPartition(Ljava/lang/String;)I
    ...
    const-string v26, " info.add(cooked[3]);"
    ...
    invoke-virtual {v13, v0}, Landroid/os/storage/DiskInfo;->add(Ljava/lang/String;)V
    ...
    aget-object v15, p3, v25

    .line 979
    .local v15, label:Ljava/lang/String;
    const/16 v25, 0x3

    aget-object v20, p3, v25
    ...
    .line 1000
    new-instance v25, Lcom/android/server/MountService$5;
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    iget-object v8, p0, Lcom/android/server/MountService;->mPower:Landroid/os/PowerManager;
    ...
    const-string v10, "meizu.intent.action.UMS_ENABLED"
    ...
    invoke-direct {v4, p0, v1, v0, v6}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v9, v6, v4}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    const-string v8, "meizu.intent.action.UMS_DISABLED"
