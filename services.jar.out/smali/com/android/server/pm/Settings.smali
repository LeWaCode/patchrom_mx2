...
.field private static final TAG_GUEST_COMPONENTS:Ljava/lang/String; = "guest-components"
...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;IILandroid/os/UserHandle;ZZ)Lcom/android/server/pm/PackageSetting;
    ...
    invoke-virtual/range {v3 .. v11}, Lcom/android/server/pm/PackageSettingBase;->setUserState(IIZZZLjava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
    ...
    iget-object v5, v12, Lcom/android/server/pm/GrantedPermissions;->mPermissions:Ljava/util/HashMap;

    invoke-direct {v4, v5}, Ljava/util/HashMap;-><init>(Ljava/util/Map;)V

    iput-object v4, v3, Lcom/android/server/pm/GrantedPermissions;->mPermissions:Ljava/util/HashMap;
...
.method private readDisabledSysPackageLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v6, v2, Lcom/android/server/pm/GrantedPermissions;->mPermissions:Ljava/util/HashMap;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v1, v5, v6}, Lcom/android/server/pm/Settings;->readGrantedPermissionsLPw(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashSet;Ljava/util/HashMap;)V
...
.method private readGrantedPermissionsLPw(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashSet;Ljava/util/HashMap;)V
    .locals 8
    .parameter "parser"
    .parameter
    .parameter
    ...
    .local p3, outMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Lcom/android/server/pm/PermissionItem;>;"
    const/4 v7, 0x5
...
.method private readGuestComponentsLPw(Lcom/android/server/pm/PackageSettingBase;Lorg/xmlpull/v1/XmlPullParser;I)V
    .locals 8
    .parameter "packageSetting"
    .parameter "parser"
    .parameter "userId"
    ...
    invoke-virtual {p1, v4, p3}, Lcom/android/server/pm/PackageSettingBase;->addGuestComponent(Ljava/lang/String;I)Z
    ...
    const-string v5, "Error in package manager settings: <guest-components> has no name at "
    ...
    const-string v5, "Unknown element under <guest-components>: "
...
.method private readPackageLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 2227
    :cond_1b
    const-string v3, "guest-components"
    ...
    invoke-direct {v0, v2, v1, v3}, Lcom/android/server/pm/Settings;->readGuestComponentsLPw(Lcom/android/server/pm/PackageSettingBase;Lorg/xmlpull/v1/XmlPullParser;I)V
    ...
    iget-object v5, v2, Lcom/android/server/pm/GrantedPermissions;->mPermissions:Ljava/util/HashMap;

    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-direct {v0, v1, v3, v5}, Lcom/android/server/pm/Settings;->readGrantedPermissionsLPw(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashSet;Ljava/util/HashMap;)V
...
.method private readSharedUserLPw(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iget-object v10, v5, Lcom/android/server/pm/GrantedPermissions;->mPermissions:Ljava/util/HashMap;

    invoke-direct {p0, p1, v9, v10}, Lcom/android/server/pm/Settings;->readGrantedPermissionsLPw(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashSet;Ljava/util/HashMap;)V
...
.method getComponentGuestSettingLPr(Landroid/content/ComponentName;I)Z
    .locals 4
    .parameter "componentName"
    .parameter "userId"
    ...
    .line 2632
    .local v0, classNameStr:Ljava/lang/String;
    invoke-virtual {v2, v0, p2}, Lcom/android/server/pm/PackageSettingBase;->getCurrentGuestStateLPr(Ljava/lang/String;I)Z
...
.method getGuestSettingsLPrList(I)Ljava/util/List;
    .locals 10
    .parameter "userId"
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .line 2637
    .local v5, pkgList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/content/ComponentName;>;"
    ...
    invoke-virtual {v4, p1}, Lcom/android/server/pm/PackageSettingBase;->readUserState(I)Landroid/content/pm/PackageUserState;

    move-result-object v6

    .line 2639
    .local v6, ustate:Landroid/content/pm/PackageUserState;
    if-eqz v6, :cond_0

    iget-object v7, v6, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
    ...
    iget-object v9, v4, Lcom/android/server/pm/PackageSettingBase;->name:Ljava/lang/String;
    ...
    iget-object v7, v4, Lcom/android/server/pm/PackageSettingBase;->name:Ljava/lang/String;
    ...
    .end local v6           #ustate:Landroid/content/pm/PackageUserState;
    :cond_1
    return-object v5
.end method
...
.method isGuestHideLPr(Ljava/lang/String;Landroid/content/pm/ComponentInfo;I)Z
    .locals 8
    .parameter "packageName"
    .parameter "componentInfo"
    .parameter "userId"
    ...
    .end local v1           #packageSettings:Lcom/android/server/pm/PackageSetting;
    ...
    .line 2574
    .restart local v1       #packageSettings:Lcom/android/server/pm/PackageSetting;
    ...
    .line 2575
    .local v3, ustate:Landroid/content/pm/PackageUserState;
    iget v6, v3, Landroid/content/pm/PackageUserState;->enabled:I
    ...
    .line 2582
    :cond_4
    iget-object v6, v3, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
...
.method readPackageRestrictionsLPr(I)V
    ...
    .line 909
    .local v12, guestComponens:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    invoke-interface/range {v22 .. v22}, Lorg/xmlpull/v1/XmlPullParser;->getDepth()I
    ...
    .end local v12           #guestComponens:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    .restart local v12       #guestComponens:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    .line 922
    :cond_10
    const-string v5, "guest-components"
    ...
    .line 927
    invoke-virtual/range {v4 .. v12}, Lcom/android/server/pm/PackageSettingBase;->setUserState(IIZZZLjava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
...
.method updateSharedUserPermsLPw(Lcom/android/server/pm/PackageSetting;[I)V
    ...
    .line 633
    iget-object v8, v6, Lcom/android/server/pm/GrantedPermissions;->mPermissions:Ljava/util/HashMap;
...
.method writePackageRestrictionsLPr(I)V
    ...
    :cond_5
    iget-object v13, v12, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
    ...
    const-string v14, "guest-components"
