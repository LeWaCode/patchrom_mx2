...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v12}, Lcom/android/server/AlarmManagerService;->access$900(Lcom/android/server/AlarmManagerService;)Ljava/lang/Object;
    ...
    invoke-virtual {v12, v8}, Lcom/android/server/AlarmManagerService;->lookForPackageLocked(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v12}, Landroid/content/BroadcastReceiver;->setResultCode(I)V
    ...
    invoke-virtual {v12, v9}, Lcom/android/server/AlarmManagerService;->removeLocked(Ljava/lang/String;)V

    invoke-virtual {v12, v9}, Lcom/android/server/AlarmManagerService;->killLewaSystemProcess(Ljava/lang/String;)V

    iget-object v12, p0, Lcom/android/server/AlarmManagerService$UninstallReceiver;->this$0:Lcom/android/server/AlarmManagerService;

    const-string v14, ""

    invoke-virtual {v12, v14}, Lcom/android/server/AlarmManagerService;->removeLocked(Ljava/lang/String;)V

    .line 1683
    iget-object v12, p0, Lcom/android/server/AlarmManagerService$UninstallReceiver;->this$0:Lcom/android/server/AlarmManagerService;

    #getter for: Lcom/android/server/AlarmManagerService;->mBroadcastStats:Ljava/util/HashMap;
    invoke-static {v12}, Lcom/android/server/AlarmManagerService;->access$3900(Lcom/android/server/AlarmManagerService;)Ljava/util/HashMap;
    ...
    .line 1670
    .local v5, inner_app:Z
    iget-object v12, p0, Lcom/android/server/AlarmManagerService$UninstallReceiver;->this$0:Lcom/android/server/AlarmManagerService;

    #getter for: Lcom/android/server/AlarmManagerService;->whitelist_packagename_inner:[Ljava/lang/String;
    invoke-static {v12}, Lcom/android/server/AlarmManagerService;->access$3700(Lcom/android/server/AlarmManagerService;)[Ljava/lang/String;
    ...
    .line 1671
    .local v6, inner_pkg:Ljava/lang/String;
    ...
    .line 1676
    .end local v6           #inner_pkg:Ljava/lang/String;
    :cond_7
    if-nez v5, :cond_3

    iget-object v12, p0, Lcom/android/server/AlarmManagerService$UninstallReceiver;->this$0:Lcom/android/server/AlarmManagerService;

    #getter for: Lcom/android/server/AlarmManagerService;->whitelist_packagename:Ljava/util/ArrayList;
    invoke-static {v12}, Lcom/android/server/AlarmManagerService;->access$3800(Lcom/android/server/AlarmManagerService;)Ljava/util/ArrayList;
    ...
    .line 1670
    .restart local v6       #inner_pkg:Ljava/lang/String;
    :cond_8
    add-int/lit8 v4, v4, 0x1
