...
.field public static final GOOGLE_LOCATION_PACKAGENAME:Ljava/lang/String; = "com.google.android.location"
...
.field private static final RESOLUTION_LEVEL_COARSE_LIMIT:I = 0x3

.field private static final RESOLUTION_LEVEL_FINE:I = 0x2

.field private static final RESOLUTION_LEVEL_FINE_LIMIT:I = 0x4
...
.method static synthetic access$1500(Lcom/android/server/LocationManagerService;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$400(Lcom/android/server/LocationManagerService;Landroid/content/Intent;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$500(Lcom/android/server/LocationManagerService;)V
    ...
    .prologue
    .line 93
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->doSimStateChanged()V
...
.method private doCampedNetworkStateChanged(Landroid/content/Intent;)V
    ...
    const-string v5, "doCampedNetworkStateChanged intent="
...
.method private doSimStateChanged()V
    .locals 6
    ...
    const-string v5, "doSimStateChangedimsi="
...
.method private getAllowedResolutionLevel(II)I
    ...
    invoke-virtual {v3, v4, p1, p2}, Landroid/content/Context;->checkPermission(Ljava/lang/String;II)I

    move-result v1

    .line 937
    .local v1, fineLocation:I
    iget-object v3, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;
...
.method private getAllowedResolutionLevelMz(II)I
    .locals 5
    .parameter "pid"
    .parameter "uid"
    ...
    invoke-virtual {v3, v4, p1, p2}, Landroid/content/Context;->checkPermissionMz(Ljava/lang/String;II)I
...
.method private getCallerAllowedResolutionLevelMz()I
    .locals 2
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/server/LocationManagerService;->getAllowedResolutionLevelMz(II)I
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    const-string v30, "skipping loc update for no op app: "
    ...
    invoke-static {v15, v9, v0, v1, v2}, Lcom/android/server/LocationManagerService;->shouldBroadcastSafe(Landroid/location/Location;Landroid/location/Location;Lcom/android/server/LocationManagerService$UpdateRecord;J)Z
    ...
    invoke-direct {v9, v15}, Landroid/location/Location;-><init>(Landroid/location/Location;)V
    ...
    .restart local v9       #lastLoc:Landroid/location/Location;
    :cond_12
    invoke-virtual {v9, v15}, Landroid/location/Location;->set(Landroid/location/Location;)V
...
.method private init()V
    ...
    invoke-virtual {v12, v6, v0}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    .line 413
    new-instance v11, Lcom/android/server/LocationManagerService$1;

    invoke-direct {v11, p0}, Lcom/android/server/LocationManagerService$1;-><init>(Lcom/android/server/LocationManagerService;)V

    .line 420
    .local v11, callback:Landroid/app/AppOpsManager$Callback;
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mAppOps:Landroid/app/AppOpsManager;

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v4, v11}, Landroid/app/AppOpsManager;->startWatchingMode(ILjava/lang/String;Landroid/app/AppOpsManager$Callback;)V
    ...
    invoke-virtual {v0, v1, v6, v2, v5}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    .line 452
    .local v8, networkStateFilter:Landroid/content/IntentFilter;
    ...
    new-instance v6, Lcom/android/server/LocationManagerService$NetworkStateReceiver;

    invoke-direct {v6, p0, v4}, Lcom/android/server/LocationManagerService$NetworkStateReceiver;-><init>(Lcom/android/server/LocationManagerService;Lcom/android/server/LocationManagerService$1;)V
    ...
    .end local v8           #networkStateFilter:Landroid/content/IntentFilter;
    .end local v11           #callback:Landroid/app/AppOpsManager$Callback;
    :catchall_0
    move-exception v0
...
.method private initSettingProvider()V
    ...
    const-string v5, "network_provider_package"
    ...
    const-string v5, "load baidu network provider"
    ...
    const-string v5, "load google network provider"
...
.method private loadProvidersLocked()V
    ...
    .line 562
    :cond_1
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->initSettingProvider()V
...
.method checkLocationAccess(ILjava/lang/String;I)Z
    ...
    invoke-virtual {v0, v1, p1, p2}, Landroid/app/AppOpsManager;->noteOpNoThrow(IILjava/lang/String;)I
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-direct {p0, v4, v10}, Lcom/android/server/LocationManagerService;->isAllowedBySettingsLocked(Ljava/lang/String;I)Z
    ...
    .line 1666
    iget-object v8, p0, Lcom/android/server/LocationManagerService;->mLocationFudger:Lcom/android/server/location/LocationFudger;

    invoke-virtual {v8, v5}, Lcom/android/server/location/LocationFudger;->getOrCreate(Landroid/location/Location;)Landroid/location/Location;
...
.method public getProviders(Landroid/location/Criteria;Z)Ljava/util/List;
    ...
    .line 1138
    .local v7, out:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    iget-object v9, p0, Lcom/android/server/LocationManagerService;->mProviders:Ljava/util/ArrayList;
    ...
    invoke-interface {v8}, Lcom/android/server/location/LocationProviderInterface;->getName()Ljava/lang/String;
    ...
    .line 1146
    invoke-direct {p0, v6}, Lcom/android/server/LocationManagerService;->getMinimumResolutionLevelForProviderUse(Ljava/lang/String;)I
    ...
    invoke-direct {p0, v6, v1}, Lcom/android/server/LocationManagerService;->isAllowedBySettingsLocked(Ljava/lang/String;I)Z
    ...
    invoke-interface {v8}, Lcom/android/server/location/LocationProviderInterface;->getProperties()Lcom/android/internal/location/ProviderProperties;

    move-result-object v9

    invoke-static {v6, v9, p1}, Landroid/location/LocationProvider;->propertiesMeetCriteria(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;Landroid/location/Criteria;)Z
    ...
    .end local v7           #out:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .restart local v7       #out:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    :cond_5
    :try_start_3
    monitor-exit v10
    :try_end_3
...
.method public isProviderEnabled(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v4}, Lcom/android/server/LocationManagerService;->isAllowedBySettingsLocked(Ljava/lang/String;I)Z
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    .line 1492
    invoke-direct {p0}, Lcom/android/server/LocationManagerService;->getCallerAllowedResolutionLevelMz()I
...
.method public sendExtraCommand(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string v4, "Requires ACCESS_LOCATION_EXTRA_COMMANDS permission"
    ...
    .line 1804
    .restart local v1       #p:Lcom/android/server/location/LocationProviderInterface;
    :cond_4
    :try_start_1
