...
.field mzPr:Lcom/meizu/widget/MeizuAppSecurityPermissions;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Ljava/lang/String;J)V
    ...
    .line 139
    iput-object v1, p0, Lcom/android/server/am/BroadcastQueue;->mzPr:Lcom/meizu/widget/MeizuAppSecurityPermissions;
...
.method private final deliverToRegisteredReceiverLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;Z)V
    ...
    invoke-static/range {v2 .. v11}, Lcom/android/server/am/BroadcastQueue;->performReceiveLocked(Lcom/android/server/am/ProcessRecord;Landroid/content/IIntentReceiver;Landroid/content/Intent;ILjava/lang/String;Landroid/os/Bundle;ZZIZ)V
    ...
    .restart local v13       #perm:I
    :cond_6
    sget-object v2, Landroid/os/Build;->MeizuSecurity:Ljava/lang/Boolean;
    ...
    iget-object v2, v0, Lcom/android/server/am/BroadcastQueue;->mzPr:Lcom/meizu/widget/MeizuAppSecurityPermissions;

    if-nez v2, :cond_7

    .line 448
    new-instance v2, Lcom/meizu/widget/MeizuAppSecurityPermissions;
    ...
    invoke-direct {v2, v3}, Lcom/meizu/widget/MeizuAppSecurityPermissions;-><init>(Landroid/content/Context;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/am/BroadcastQueue;->mzPr:Lcom/meizu/widget/MeizuAppSecurityPermissions;
    ...
    invoke-virtual {v2, v3, v4, v5, v13}, Lcom/meizu/widget/MeizuAppSecurityPermissions;->checkLimitedPermissionReceiver(Ljava/lang/String;III)I
...
.method private static performReceiveLocked(Lcom/android/server/am/ProcessRecord;Landroid/content/IIntentReceiver;Landroid/content/Intent;ILjava/lang/String;Landroid/os/Bundle;ZZIZ)V
    .locals 10
    .parameter "app"
    .parameter "receiver"
    .parameter "intent"
    ...
    const-string v3, "scheduleRegisteredReceiver  appprocessName:"
    ...
    invoke-interface/range {v1 .. v9}, Landroid/app/IApplicationThread;->scheduleRegisteredReceiver(Landroid/content/IIntentReceiver;Landroid/content/Intent;ILjava/lang/String;Landroid/os/Bundle;ZZI)V
    ...
    const-string v3, "scheduleRegisteredReceiver  receiver:"
...
.method final broadcastTimeoutLocked(Z)V
    ...
    iget-wide v14, v0, Lcom/android/server/am/BroadcastQueue;->mTimeoutPeriod:J
    ...
    const-string v6, "broadcastTimeoutLocked [] "
    ...
    .line 975
    .restart local v19       #timeoutTime:J
    cmp-long v3, v19, v16
...
.method public finishReceiverLocked(Lcom/android/server/am/BroadcastRecord;ILjava/lang/String;Landroid/os/Bundle;ZZ)Z
    ...
    const-string v6, "finishReceiverLocked: r: "
    ...
    .line 356
    :cond_1
    iget v1, p1, Lcom/android/server/am/BroadcastRecord;->state:I
    ...
    iput-object v7, v4, Lcom/android/server/am/ProcessRecord;->curReceiver:Lcom/android/server/am/BroadcastRecord;
    ...
    iput-object v7, v4, Lcom/android/server/am/ReceiverList;->curBroadcast:Lcom/android/server/am/BroadcastRecord;
...
.method final processNextBroadcast(Z)V
    ...
    invoke-static/range {v3 .. v12}, Lcom/android/server/am/BroadcastQueue;->performReceiveLocked(Lcom/android/server/am/ProcessRecord;Landroid/content/IIntentReceiver;Landroid/content/Intent;ILjava/lang/String;Landroid/os/Bundle;ZZIZ)V
    ...
    const-string v6, "Is a ACTION_SCREEN Intent [] "
    ...
    iget-object v3, v0, Lcom/android/server/am/BroadcastQueue;->mzPr:Lcom/meizu/widget/MeizuAppSecurityPermissions;

    if-nez v3, :cond_26

    .line 768
    new-instance v3, Lcom/meizu/widget/MeizuAppSecurityPermissions;
    ...
    invoke-direct {v3, v5}, Lcom/meizu/widget/MeizuAppSecurityPermissions;-><init>(Landroid/content/Context;)V

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/am/BroadcastQueue;->mzPr:Lcom/meizu/widget/MeizuAppSecurityPermissions;
    ...
    invoke-virtual {v3, v5, v6, v7, v8}, Lcom/meizu/widget/MeizuAppSecurityPermissions;->checkContentPermissionReceiver(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)I
    ...
    .line 866
    .local v26, mAppOps:Landroid/app/AppOpsManager;
    if-eqz v26, :cond_2a

    invoke-virtual/range {v26 .. v26}, Landroid/app/AppOpsManager;->getFactoryState()Z
    ...
    invoke-virtual {v0, v3, v5, v6}, Landroid/app/AppOpsManager;->checkOpNoThrow(IILjava/lang/String;)I
    :try_end_10
    ...
    .line 880
    .end local v15           #check:I
    .end local v26           #mAppOps:Landroid/app/AppOpsManager;
    :cond_2a
    :goto_b
    if-eqz v24, :cond_2b
    ...
    const-string v6, "Limit: Unable to launch app "
