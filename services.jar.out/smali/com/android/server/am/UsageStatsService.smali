...
# instance fields
.field final CPU_BOOST_HIGH:I

.field final CPU_BOOST_LOW:I

.field final CPU_BOOST_NORMAL:I

.field isInHomeActivity:Z
...
.method constructor <init>(Ljava/lang/String;)V
    ...
    .line 685
    iput-boolean v8, p0, Lcom/android/server/am/UsageStatsService;->isInHomeActivity:Z

    .line 704
    iput v7, p0, Lcom/android/server/am/UsageStatsService;->CPU_BOOST_HIGH:I

    .line 705
    iput v8, p0, Lcom/android/server/am/UsageStatsService;->CPU_BOOST_NORMAL:I

    .line 706
    const/4 v4, 0x2

    iput v4, p0, Lcom/android/server/am/UsageStatsService;->CPU_BOOST_LOW:I
...
.method public notePauseComponent(Lcom/android/server/am/ActivityRecord;)V
    .locals 5
    ...
    const-string v4, "notePauseComponent -- "
    ...
    const-string v2, "meizu.intent.action.HOME_SHOWN"
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lcom/android/server/am/UsageStatsService;->notePauseComponent(Landroid/content/ComponentName;)V
...
.method public noteResumeComponent(Lcom/android/server/am/ActivityRecord;)V
    .locals 6
    .parameter "resumedComponent"
    ...
    const-string v4, "noteResumeComponent -- "
    ...
    invoke-virtual {p0, v2, v3}, Lcom/android/server/am/UsageStatsService;->setCpuBoost(J)Z

    .line 722
    iput-boolean v5, p0, Lcom/android/server/am/UsageStatsService;->isInHomeActivity:Z

    .line 728
    .end local v1           #intent:Landroid/content/Intent;
    :cond_0
    :goto_0
    invoke-virtual {p0, v0}, Lcom/android/server/am/UsageStatsService;->noteResumeComponent(Landroid/content/ComponentName;)V
    ...
    .line 723
    :cond_1
    iget-boolean v2, p0, Lcom/android/server/am/UsageStatsService;->isInHomeActivity:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/am/UsageStatsService;->isInHomeActivity:Z
...
.method setCpuBoost(J)Z
    ...
    .line 689
    const-string v0, "/sys/class/touch_booster/boost_level"

    .line 691
    .local v0, boost_freq:Ljava/lang/String;
    :try_start_0
    ...
    const-string v6, "/sys/class/touch_booster/boost_cpufreq do not exist"
