...
.field private static final IDS_IME_DEFAULT:[Ljava/lang/String; = null

.field private static final IDS_IME_VOICE:[Ljava/lang/String; = null
...
.field private final mMeizuLock:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/InputMethodManagerService;->IDS_IME_VOICE:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/server/InputMethodManagerService;->IDS_IME_DEFAULT:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .line 4198
    iput v12, p0, Lcom/android/server/InputMethodManagerService;->mMeizuFlags:I
...
.method static synthetic access$1900(Lcom/android/server/InputMethodManagerService;Ljava/lang/String;)Ljava/util/HashMap;
    .locals 1
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 122
    invoke-direct {p0, p1}, Lcom/android/server/InputMethodManagerService;->getExplicitlyOrImplicitlyEnabledInputMethodsAndSubtypeListLocked(Ljava/lang/String;)Ljava/util/HashMap;
...
.method static synthetic access$2100(Landroid/view/inputmethod/InputMethodInfo;)Z
    .locals 1
    .parameter "x0"
...
.method private getExplicitlyOrImplicitlyEnabledInputMethodsAndSubtypeListLocked(Ljava/lang/String;)Ljava/util/HashMap;
    .locals 5
    .parameter "lastInputMethodId"
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
    ...
    invoke-static {v2}, Lcom/android/server/InputMethodManagerService;->isVoiceIme(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/server/InputMethodManagerService;->getEnabledInputMethodSubtypeListLocked(Landroid/view/inputmethod/InputMethodInfo;Z)Ljava/util/List;
...
.method private static isDefaultIme(Ljava/lang/String;)Z
    .locals 1
    .parameter "id"

    .prologue
    .line 2468
    sget-object v0, Lcom/android/server/InputMethodManagerService;->IDS_IME_DEFAULT:[Ljava/lang/String;

    invoke-static {p0, v0}, Lcom/android/server/InputMethodManagerService;->strInArray(Ljava/lang/String;[Ljava/lang/String;)Z
...
.method private isValidSystemDefaultIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lcom/android/server/InputMethodManagerService;->isDefaultIme(Ljava/lang/String;)Z
...
.method private static isVoiceIme(Ljava/lang/String;)Z
    .locals 1
    .parameter "id"

    .prologue
    .line 2464
    sget-object v0, Lcom/android/server/InputMethodManagerService;->IDS_IME_VOICE:[Ljava/lang/String;
...
.method private needsToShowImeSwitchOngoingNotification()Z
    ...
    invoke-static {v12}, Lcom/android/server/InputMethodManagerService;->isVoiceIme(Ljava/lang/String;)Z
...
.method private setInputShownLocked(Z)V
    .locals 5
    .parameter "shown"
...
.method private showInputMethodMenuInternal(Z)V
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getSelectedInputMethod()Ljava/lang/String;

    move-result-object v17

    .line 2647
    .local v17, lastInputMethodId:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 2650
    .local v18, lastInputMethodSubtypeId:I
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1}, Lcom/android/server/InputMethodManagerService;->getExplicitlyOrImplicitlyEnabledInputMethodsAndSubtypeListLocked(Ljava/lang/String;)Ljava/util/HashMap;

    move-result-object v13

    .line 2654
    .local v13, immis:Ljava/util/HashMap;,"Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    if-eqz v13, :cond_0
    ...
    invoke-virtual {v0, v1, v2, v14, v3}, Lcom/android/server/InputMethodManagerService$InputMethodAndSubtypeListManager;->getSortedInputMethodAndSubtypeList(ZZZLjava/lang/String;)Ljava/util/List;
    ...
    check-cast v15, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;

    .line 2679
    .local v15, item:Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    move-object/from16 v0, p0
    ...
    iget-object v0, v15, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;->mImi:Landroid/view/inputmethod/InputMethodInfo;
    ...
    iget v0, v15, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;->mSubtypeId:I
    ...
    .line 2690
    .end local v15           #item:Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    :cond_6
    const/16 v21, 0x0

    sget-object v23, Lcom/android/internal/R$styleable;->DialogPreference:[I
    ...
    .line 2756
    .restart local v15       #item:Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    const/4 v10, 0x0
    ...
    .line 2758
    .restart local v15       #item:Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    iget-object v12, v15, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;->mImeName:Ljava/lang/CharSequence;

    .line 2759
    .local v12, imeName:Ljava/lang/CharSequence;
    iget-object v0, v15, Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;->mSubtypeName:Ljava/lang/CharSequence;

    move-object/from16 v20, v0

    .line 2760
    .local v20, subtypeName:Ljava/lang/CharSequence;
    ...
    .end local v12           #imeName:Ljava/lang/CharSequence;
    .end local v13           #immis:Ljava/util/HashMap;,"Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .end local v15           #item:Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    .end local v16           #items:[Ljava/lang/CharSequence;
    .end local v20           #subtypeName:Ljava/lang/CharSequence;
    :catchall_0
    move-exception v21
    ...
    .restart local v11       #imList:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    .restart local v13       #immis:Ljava/util/HashMap;,"Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .restart local v15       #item:Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;
    ...
    const-string v23, "Select input method"
...
.method private static strInArray(Ljava/lang/String;[Ljava/lang/String;)Z
    .locals 5
    .parameter "str"
    .parameter "arr"
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;)V
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getDisabledSystemInputMethods()Ljava/lang/String;
    ...
    #calls: Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getEnabledInputMethodsStr()Ljava/lang/String;
    invoke-static/range {v18 .. v18}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->access$1200(Lcom/android/server/InputMethodManagerService$InputMethodSettings;)Ljava/lang/String;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getCurrentUserId()I
    ...
    .end local v9           #enabledImesEmpty:Z
    .end local v10           #haveHardKeyboard:Z
    .end local v11           #i:I
    .end local v15           #ri:Landroid/content/pm/ResolveInfo;
    .end local v16           #services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    .restart local v9       #enabledImesEmpty:Z
    .restart local v10       #haveHardKeyboard:Z
    .restart local v11       #i:I
    .restart local v15       #ri:Landroid/content/pm/ResolveInfo;
    .restart local v16       #services:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    ...
    invoke-direct {v0, v13, v1}, Lcom/android/server/InputMethodManagerService;->isValidSystemDefaultIme(Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)Z
    ...
    invoke-static {v13}, Lcom/android/server/InputMethodManagerService;->isSystemImeThatHasEnglishSubtype(Landroid/view/inputmethod/InputMethodInfo;)Z
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getSelectedInputMethod()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :goto_9
    invoke-interface {v6, v3}, Lcom/android/internal/view/IInputMethodClient;->onInputShownChanged(Z)V
    :try_end_b
    ...
    const-string v7, "Got RemoteException sending onInputShownChanged("
    ...
    const-string v4, ") notification to pid "
    ...
    invoke-direct {p0, v3}, Lcom/android/server/InputMethodManagerService;->finishInputInternal(Lcom/android/internal/view/IInputMethodClient;)V
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    .line 1853
    :cond_3
    invoke-direct {p0, v1}, Lcom/android/server/InputMethodManagerService;->setInputShownLocked(Z)V
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/InputMethodManagerService;->setInputShownLocked(Z)V
...
.method showCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    .line 1764
    invoke-direct {p0, v8}, Lcom/android/server/InputMethodManagerService;->setInputShownLocked(Z)V
...
.method startInputUncheckedLocked(Lcom/android/server/InputMethodManagerService$ClientState;Lcom/android/internal/view/IInputContext;Landroid/view/inputmethod/EditorInfo;I)Lcom/android/internal/view/InputBindResult;
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/os/HandlerCaller;->removeMessages(I)V
