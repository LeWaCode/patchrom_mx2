...
.field private static final USE_RESIZE_BUFFER:Z
...
.field private mFpsPaint:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;)V
    ...
    .line 2773
    iput-boolean v3, p0, Landroid/view/ViewRootImpl;->mForceLayoutByOrientation:Z
    ...
    iput v0, p0, Landroid/view/ViewRootImpl;->mFps:F

    .line 5688
    const-string v0, "1"

    const-string/jumbo v4, "user.meizu.showfps"
    ...
    :goto_1
    iput-boolean v0, p0, Landroid/view/ViewRootImpl;->showFps:Z
    ...
    iput-object v0, p0, Landroid/view/ViewRootImpl;->mShadowTouchPoint:Landroid/graphics/Point;

    .line 5704
    iput-boolean v3, p0, Landroid/view/ViewRootImpl;->mStatusBarNfcShareEnabled:Z
...
.method private deliverPointerEvent(Landroid/view/ViewRootImpl$QueuedInputEvent;)V
    ...
    invoke-interface {v4, v5, v6}, Landroid/view/IWindowSession;->setZOrderOnTop(Landroid/view/IWindow;Z)V
    :try_end_0
...
.method private draw(Z)V
    ...
    iget-boolean v4, v0, Landroid/view/ViewRootImpl;->showFps:Z
...
.method private drawFps(Landroid/graphics/Canvas;)V
    .locals 7
    .parameter "canvas"
    ...
    .line 5690
    iget-object v0, p0, Landroid/view/ViewRootImpl;->mFpsPaint:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Landroid/view/ViewRootImpl;->mFpsPaint:Landroid/text/TextPaint;
    ...
    iget-object v5, p0, Landroid/view/ViewRootImpl;->mFpsPaint:Landroid/text/TextPaint;
    ...
    iget v3, p0, Landroid/view/ViewRootImpl;->mFps:F
    ...
    iget-object v3, p0, Landroid/view/ViewRootImpl;->mFpsPaint:Landroid/text/TextPaint;
...
.method private drawSoftware(Landroid/view/Surface;Landroid/view/View$AttachInfo;IZLandroid/graphics/Rect;)Z
    ...
    .line 2369
    :cond_6
    iget-boolean v8, p0, Landroid/view/ViewRootImpl;->showFps:Z

    if-eqz v8, :cond_7

    .line 2370
    invoke-direct {p0, v1}, Landroid/view/ViewRootImpl;->drawFps(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v9, p0, Landroid/view/ViewRootImpl;->showFps:Z
...
.method private fitSystemWindowsInner(Landroid/view/View;)V
    ...
    iget-object v2, p0, Landroid/view/ViewRootImpl;->mFitSystemWindowsInsets:Landroid/graphics/Rect;

    iget-object v3, p0, Landroid/view/ViewRootImpl;->mAttachInfo:Landroid/view/View$AttachInfo;

    iget-object v3, v3, Landroid/view/View$AttachInfo;->mContentInsets:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Landroid/view/ViewRootImpl;->mFitSystemWindowsInsets:Landroid/graphics/Rect;
    ...
    .line 5655
    .local v0, bottom:I
    iget-object v2, p0, Landroid/view/ViewRootImpl;->mLastOverlayLayout:Landroid/view/View;

    if-nez v2, :cond_0

    iget-object v2, p0, Landroid/view/ViewRootImpl;->mLastContentView:Landroid/view/View;
    ...
    invoke-virtual {v2, v4, v4, v4, v0}, Landroid/view/View;->internalSetPadding(IIII)V

    .line 5659
    :cond_0
    iget-object v2, p0, Landroid/view/ViewRootImpl;->mFitSystemWindowsInsets:Landroid/graphics/Rect;

    invoke-virtual {p1, v2}, Landroid/view/View;->fitSystemWindows(Landroid/graphics/Rect;)Z
...
.method private mzGetImeOffset()I
    ...
    .line 5640
    iget-object v0, p0, Landroid/view/ViewRootImpl;->mLastSplitActionBar:Landroid/view/View;
...
.method private performTraversals()V
    ...
    .line 1149
    .local v52, params:Landroid/view/WindowManager$LayoutParams;
    move-object/from16 v0, p0
    ...
    .line 1243
    .local v53, refreshWhenStopped:Z
    move-object/from16 v0, p0

    iget-boolean v4, v0, Landroid/view/ViewRootImpl;->mForceLayoutByOrientation:Z
    ...
    .line 1246
    .local v51, packageMetrics:Landroid/util/DisplayMetrics;
    ...
    iput-boolean v4, v0, Landroid/view/ViewRootImpl;->mForceLayoutByOrientation:Z

    .line 1262
    .end local v51           #packageMetrics:Landroid/util/DisplayMetrics;
    :cond_a
    :goto_5
    move-object/from16 v0, p0
    ...
    .end local v52           #params:Landroid/view/WindowManager$LayoutParams;
    .end local v53           #refreshWhenStopped:Z
    ...
    .restart local v52       #params:Landroid/view/WindowManager$LayoutParams;
    ...
    .line 1184
    .restart local v51       #packageMetrics:Landroid/util/DisplayMetrics;
    move-object/from16 v0, v51
    ...
    .restart local v53       #refreshWhenStopped:Z
    :cond_17
    :try_start_0
    move-object/from16 v0, p0
    ...
    invoke-interface {v4, v10}, Landroid/view/IWindowSession;->isWindowVisibleBehindSlideKeyguard(Landroid/view/IWindow;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1355
    .local v58, splitActionBarHeight:I
    move-object/from16 v0, p0
    ...
    .end local v58           #splitActionBarHeight:I
    .end local v67           #windowShouldResize:Z
    :cond_36
    and-int/lit8 v49, v49, -0x3

    goto/16 :goto_a

    .line 1358
    .restart local v58       #splitActionBarHeight:I
    :cond_37
    if-lez v58, :cond_38
...
.method public onHardwarePostDraw(Landroid/view/HardwareCanvas;)V
    ...
    .line 2032
    iget-boolean v0, p0, Landroid/view/ViewRootImpl;->showFps:Z

    if-eqz v0, :cond_1

    .line 2033
    invoke-direct {p0, p1}, Landroid/view/ViewRootImpl;->drawFps(Landroid/graphics/Canvas;)V
...
.method scrollToRectOrFocus(Landroid/graphics/Rect;Z)Z
    ...
    iget-object v7, v0, Landroid/view/View$AttachInfo;->mVisibleInsets:Landroid/graphics/Rect;

    .line 2462
    .local v7, vi:Landroid/graphics/Rect;
    invoke-direct {p0}, Landroid/view/ViewRootImpl;->mzGetImeOffset()I
    ...
    iget-object v8, p0, Landroid/view/ViewRootImpl;->mLastContentView:Landroid/view/View;
    ...
    iget v6, v8, Landroid/view/View;->mScrollY:I
    ...
    iget-object v8, v2, Landroid/view/View;->mAttachInfo:Landroid/view/View$AttachInfo;
    ...
    .line 2490
    :cond_1
    iput-object v11, p0, Landroid/view/ViewRootImpl;->mRealFocusedView:Landroid/view/View;
    ...
    :cond_4
    iget-object v8, p0, Landroid/view/ViewRootImpl;->mLastScrolledFocus:Landroid/view/View;
    ...
    iput v6, v8, Landroid/view/View;->mScrollY:I
    ...
    invoke-virtual {v2, v8, v11}, Landroid/view/View;->getGlobalVisibleRect(Landroid/graphics/Rect;Landroid/graphics/Point;)Z
    ...
    invoke-virtual {v2, v8}, Landroid/view/View;->getFocusedRect(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v8, v2, v10}, Landroid/view/ViewGroup;->offsetDescendantRectToMyCoords(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v8, v10}, Landroid/graphics/Rect;->intersect(Landroid/graphics/Rect;)Z
    ...
    iget-object v8, p0, Landroid/view/ViewRootImpl;->mResizeBuffer:Landroid/view/HardwareLayer;

    if-nez v8, :cond_13

    .line 2591
    iget-object v8, p0, Landroid/view/ViewRootImpl;->mScroller:Landroid/widget/Scroller;
    ...
    invoke-direct {v8, v10}, Landroid/widget/Scroller;-><init>(Landroid/content/Context;)V

    iput-object v8, p0, Landroid/view/ViewRootImpl;->mScroller:Landroid/widget/Scroller;
    ...
    invoke-virtual {v8, v9, v10, v9, v11}, Landroid/widget/Scroller;->startScroll(IIII)V

    .line 2598
    :cond_12
    :goto_7
    iput v6, p0, Landroid/view/ViewRootImpl;->mScrollY:I
...
.method public setView(Landroid/view/View;Landroid/view/WindowManager$LayoutParams;Landroid/view/View;)V
    ...
    iput-object v1, p0, Landroid/view/ViewRootImpl;->mLastOverlayLayout:Landroid/view/View;
    ...
    iput-object v1, p0, Landroid/view/ViewRootImpl;->mLastSplitActionBar:Landroid/view/View;
    ...
    iput-object v1, p0, Landroid/view/ViewRootImpl;->mLastActionBar:Landroid/view/View;
    ...
    iput-object v1, p0, Landroid/view/ViewRootImpl;->mLastContentView:Landroid/view/View;
