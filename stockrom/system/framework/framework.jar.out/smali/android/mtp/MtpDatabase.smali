...
.field private static final PROTECTFOLDERPATH:Ljava/lang/String; = "/storage/emulated/0/.@meizu_protbox@"
...
# instance fields
.field private PROTECTFOLDERNAME:Ljava/lang/String;
...
.field private mMzProtectBoxhandle:I
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    iput v10, p0, Landroid/mtp/MtpDatabase;->mMzProtectBoxhandle:I

    .line 368
    const-string v10, ".@meizu_protbox@"

    iput-object v10, p0, Landroid/mtp/MtpDatabase;->PROTECTFOLDERNAME:Ljava/lang/String;
...
.method private createObjectQuery(III)Landroid/database/Cursor;
    ...
    .line 468
    const-string v3, "_data NOT LIKE \'/service%\' AND (mime_type is null or mime_type != \'audio/cus\')"

    .line 474
    :goto_2
    invoke-direct {p0}, Landroid/mtp/MtpDatabase;->isInProtectMode()Z
    ...
    .line 475
    invoke-direct {p0}, Landroid/mtp/MtpDatabase;->getMzProtectBoxID()I

    move-result v10

    .line 476
    .local v10, protectId:I
    if-nez v3, :cond_11
    ...
    const-string v1, " and (_data NOT LIKE \'/service%\' AND (mime_type is null or mime_type != \'audio/cus\'))"
...
.method private getMzProtectBoxID()I
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 344
    iget v0, p0, Landroid/mtp/MtpDatabase;->mMzProtectBoxhandle:I
    ...
    .line 346
    .local v8, defaultStorage:Ljava/lang/String;
    new-instance v0, Ljava/lang/StringBuilder;
    ...
    iget-object v1, p0, Landroid/mtp/MtpDatabase;->PROTECTFOLDERNAME:Ljava/lang/String;
    ...
    iput v0, p0, Landroid/mtp/MtpDatabase;->mMzProtectBoxhandle:I
    ...
    .end local v8           #defaultStorage:Ljava/lang/String;
    :cond_1
    iget v0, p0, Landroid/mtp/MtpDatabase;->mMzProtectBoxhandle:I
...
.method private getObjectFilePath(I[C[J)I
    ...
    iget-object v2, p0, Landroid/mtp/MtpDatabase;->PROTECTFOLDERNAME:Ljava/lang/String;
...
.method private getObjectInfo(I[I[C[J)Z
    ...
    const-string v1, "/storage/emulated/0/.@meizu_protbox@"
...
.method private getObjectPropertyList(JIJII)Landroid/mtp/MtpPropertyList;
    ...
    invoke-virtual {v0, v2, v3, p3, p7}, Landroid/mtp/MtpPropertyGroup;->getPropertyList(Landroid/content/Context;III)Landroid/mtp/MtpPropertyList;
...
.method private isInProtectMode()Z
    .locals 3
    ...
    const-string/jumbo v2, "mz_show_access_password"
    ...
    const-string/jumbo v2, "mz_mtp_unlocked"
