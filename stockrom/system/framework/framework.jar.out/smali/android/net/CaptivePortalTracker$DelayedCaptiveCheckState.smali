...
.method public enter()V
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$1404(Landroid/net/CaptivePortalTracker;)I
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$1400(Landroid/net/CaptivePortalTracker;)I
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$1500(Landroid/net/CaptivePortalTracker;)Ljava/lang/String;

    move-result-object v3

    #calls: Landroid/net/CaptivePortalTracker;->lookupHost(Ljava/lang/String;)Ljava/net/InetAddress;
    invoke-static {v2, v3}, Landroid/net/CaptivePortalTracker;->access$1600(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    invoke-static {v2, v0}, Landroid/net/CaptivePortalTracker;->access$1700(Landroid/net/CaptivePortalTracker;Ljava/net/InetAddress;)Z
    ...
    invoke-static {v2, v1}, Landroid/net/CaptivePortalTracker;->access$600(Landroid/net/CaptivePortalTracker;Z)V
    ...
    invoke-static {v3}, Landroid/net/CaptivePortalTracker;->access$800(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v3

    #calls: Lcom/android/internal/util/StateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Landroid/net/CaptivePortalTracker;->access$1800(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
