...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/CaptivePortalTracker;->access$502(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;)Landroid/net/NetworkInfo;
    ...
    invoke-static {v0, v1}, Landroid/net/CaptivePortalTracker;->access$600(Landroid/net/CaptivePortalTracker;Z)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1, v0}, Landroid/net/CaptivePortalTracker;->access$700(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;)Z
    ...
    #setter for: Landroid/net/CaptivePortalTracker;->mNetworkInfo:Landroid/net/NetworkInfo;
    invoke-static {v1, v0}, Landroid/net/CaptivePortalTracker;->access$502(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;)Landroid/net/NetworkInfo;
    ...
    invoke-static {v2}, Landroid/net/CaptivePortalTracker;->access$800(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v2

    #calls: Lcom/android/internal/util/StateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/CaptivePortalTracker;->access$900(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
