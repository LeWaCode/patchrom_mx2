...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #getter for: Landroid/hardware/Camera;->mBurstCallback:Landroid/hardware/Camera$BurstPictureCallback;
    invoke-static {v3}, Landroid/hardware/Camera;->access$300(Landroid/hardware/Camera;)Landroid/hardware/Camera$BurstPictureCallback;
    ...
    invoke-interface {v4, v3, v5, v6, v7}, Landroid/hardware/Camera$BurstPictureCallback;->onPictureTaken([BIILandroid/hardware/Camera;)V
    ...
    #getter for: Landroid/hardware/Camera;->mRefocusCallback:Landroid/hardware/Camera$RefocusPictureCallback;
    invoke-static {v3}, Landroid/hardware/Camera;->access$400(Landroid/hardware/Camera;)Landroid/hardware/Camera$RefocusPictureCallback;
    ...
    invoke-interface {v4, v3, v5, v6, v7}, Landroid/hardware/Camera$RefocusPictureCallback;->onPictureTaken([BIILandroid/hardware/Camera;)V
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$500(Landroid/hardware/Camera;)Landroid/hardware/Camera$PreviewCallback;
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$700(Landroid/hardware/Camera;)Z
    ...
    invoke-static {v4, v3, v2}, Landroid/hardware/Camera;->access$800(Landroid/hardware/Camera;ZZ)V
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$1000(Landroid/hardware/Camera;)Ljava/lang/Object;
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$1200(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnZoomChangeListener;
    ...
    #getter for: Landroid/hardware/Camera;->mSecureErrorCallback:Landroid/hardware/Camera$SecureErrorCallback;
    invoke-static {v3}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$SecureErrorCallback;
    ...
    invoke-interface {v3, v4, v5}, Landroid/hardware/Camera$SecureErrorCallback;->onError(ILandroid/hardware/Camera;)V
    ...
    invoke-static {v4}, Landroid/hardware/Camera;->access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$AutoFocusMoveCallback;
