...
.method private getThemeFileStream(ILjava/lang/String;)Ljava/io/InputStream;
    .locals 5
    .parameter "resId"
    .parameter "fileName"
...
.method public getColor(I)I
    ...
    invoke-virtual {p0, p1, v7, v8}, Landroid/content/res/Resources;->getValue(ILandroid/util/TypedValue;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 776
    :try_start_1
    iget-object v8, p0, Landroid/content/res/Resources;->mThemeResource:Landroid/content/res/theme/MeizuThemeResource;
    ...
    invoke-virtual {v8, v4, v2}, Landroid/content/res/theme/MeizuThemeResource;->getThemeColor(Ljava/lang/String;Z)Landroid/content/res/theme/MeizuThemeColorInfo;

    move-result-object v6

    .line 785
    .local v6, themeColorInfo:Landroid/content/res/theme/MeizuThemeColorInfo;
    if-eqz v6, :cond_0

    .line 786
    iget-wide v10, v6, Landroid/content/res/theme/MeizuThemeColorInfo;->mColor:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .end local v6           #themeColorInfo:Landroid/content/res/theme/MeizuThemeColorInfo;
    :goto_0
    return v8
    ...
    invoke-virtual {p0, v8, p1}, Landroid/content/res/Resources;->loadColorStateList(Landroid/util/TypedValue;I)Landroid/content/res/ColorStateList;
    ...
    const-string v11, "Resource ID #0x"
    ...
    invoke-direct {v8, v10}, Landroid/content/res/Resources$NotFoundException;-><init>(Ljava/lang/String;)V
...
.method public getDrawableNoCacheAndScale(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 731
    :cond_0
    invoke-virtual {p0, v0, p1}, Landroid/content/res/Resources;->loadDrawableNoCacheAndScale(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
...
.method loadColorStateList(Landroid/util/TypedValue;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v15, v6}, Ljava/lang/Throwable;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method loadDrawable(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v1, v6}, Landroid/content/res/Resources;->getThemeFileStream(ILjava/lang/String;)Ljava/io/InputStream;
...
.method loadDrawableNoCacheAndScale(Landroid/util/TypedValue;I)Landroid/graphics/drawable/Drawable;
    ...
    const-string v9, "Resource is not a Drawable (color or path): "
    ...
    invoke-static {p0, v6}, Landroid/graphics/drawable/Drawable;->createFromXml(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_1
    invoke-direct {p0, p2, v2}, Landroid/content/res/Resources;->getThemeFileStream(ILjava/lang/String;)Ljava/io/InputStream;
    ...
    .line 2204
    .restart local v5       #rnf:Landroid/content/res/Resources$NotFoundException;
    invoke-virtual {v5, v1}, Ljava/lang/Throwable;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method public openRawResource(ILandroid/util/TypedValue;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, p1, v3}, Landroid/content/res/Resources;->getThemeFileStream(ILjava/lang/String;)Ljava/io/InputStream;
...
.method public updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    .restart local v22       #themeChange:Z
    :catchall_1
    move-exception v2
