...
.field public static final ACTION_HIDE_BT_STATUS_CHANGED:Ljava/lang/String; = "android.bluetooth.adapter.action.ACTION_HIDE_BT_STATUS_CHANGED"
...
.field private static final BROADCAST_PERMISSION_BT_TURN_OFF_PROMPT:Ljava/lang/String; = "com.android.permission.WHITELIST_BLUETOOTH_DEVICE"
...
.field public static final EXTRA_HIDE_BT_STATUS:Ljava/lang/String; = "android.bluetooth.adapter.extra.HIDE_BT_STATUS"
...
.method private createNewRfcommSocketAndRecord(Ljava/lang/String;Ljava/util/UUID;ZZI)Landroid/bluetooth/BluetoothServerSocket;
    .locals 7
    .parameter "name"
    .parameter "uuid"
    .parameter "auth"
...
.method public disableAndPrompt(Landroid/content/Context;)Z
    .locals 3
    .parameter "context"
    ...
    invoke-virtual {v0}, Landroid/nfc/NfcAdapter;->isMzNfcP2pConnected()Z
    ...
    const-string v2, "android.btopp.nfcp2p.ACTION_BT_TURN_OFF_PROMPT"

    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string v2, "com.android.permission.WHITELIST_BLUETOOTH_DEVICE"
...
.method public enable()Z
    ...
    invoke-interface {v2, v3}, Landroid/bluetooth/IBluetoothManager;->setNfcEnableBtFlag(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public enterTestMode()Z
    ...
    invoke-interface {v3}, Landroid/bluetooth/IBluetoothManager;->enterTestMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v5, "enterTestMode result "
...
.method public enterWifiTestMode()Z
    ...
    invoke-interface {v2}, Landroid/bluetooth/IBluetoothManager;->enterWifiTestMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public exitWifiTestMode()Z
    ...
    invoke-interface {v2}, Landroid/bluetooth/IBluetoothManager;->exitWifiTestMode()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isBtStatusHiden()Z
    .locals 3
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetoothManager;->isBtStatusHiden()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public listenUsingInsecureRfcommWithServiceRecord(Ljava/lang/String;Ljava/util/UUID;I)Landroid/bluetooth/BluetoothServerSocket;
    .locals 6
    .parameter "name"
    .parameter "uuid"
    .parameter "channel"
    ...
    invoke-direct/range {v0 .. v5}, Landroid/bluetooth/BluetoothAdapter;->createNewRfcommSocketAndRecord(Ljava/lang/String;Ljava/util/UUID;ZZI)Landroid/bluetooth/BluetoothServerSocket;
...
.method public nfcDisable()Z
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetoothManager;->nfcDisable()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public nfcEnableNoAutoConnect()Z
    .locals 4
    ...
    invoke-interface {v1}, Landroid/bluetooth/IBluetoothManager;->nfcEnableNoAutoConnect()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setBtStatusHiden(Z)V
    .locals 3
    .parameter "hide"
    ...
    invoke-interface {v1, p1}, Landroid/bluetooth/IBluetoothManager;->setNfcEnableBtFlag(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
