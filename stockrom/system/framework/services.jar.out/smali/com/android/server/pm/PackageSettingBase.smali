...
.method addGuestComponent(Ljava/lang/String;I)Z
    .locals 2
    .parameter "componentClassName"
    .parameter "userId"
    ...
    .prologue
    .line 323
    invoke-virtual {p0, p2}, Lcom/android/server/pm/PackageSettingBase;->modifyUserStateGuestComponents(I)Landroid/content/pm/PackageUserState;

    move-result-object v1

    iget-object v1, v1, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
...
.method getCurrentGuestStateLPr(Ljava/lang/String;I)Z
    .locals 2
    .parameter "componentName"
    .parameter "userId"
    ...
    .line 376
    .local v0, state:Landroid/content/pm/PackageUserState;
    iget-object v1, v0, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
...
.method getGuestComponentHashSet(I)Ljava/util/HashSet;
    .locals 1
    .parameter "userId"
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .line 335
    invoke-virtual {p0, p1}, Lcom/android/server/pm/PackageSettingBase;->modifyUserStateGuestComponents(I)Landroid/content/pm/PackageUserState;

    move-result-object v0

    iget-object v0, v0, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;

    return-object v0
.end method

.method getGusetHideComponents(I)Ljava/util/HashSet;
    .locals 1
    .parameter "userId"
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method modifyUserStateGuestComponents(I)Landroid/content/pm/PackageUserState;
    .locals 3
    .parameter "userId"
    ...
    iput-object v1, v0, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
...
.method removeGuestComponent(Ljava/lang/String;I)Z
    .locals 2
    .parameter "componentClassName"
    .parameter "userId"
...
.method setUserState(IIZZZLjava/util/HashSet;Ljava/util/HashSet;Ljava/util/HashSet;)V
    .locals 1
    .parameter "userId"
    .parameter "enabled"
    .parameter "installed"
    ...
    .local p8, guestComponents:Ljava/util/HashSet;,"Ljava/util/HashSet<Ljava/lang/String;>;"
    invoke-direct {p0, p1}, Lcom/android/server/pm/PackageSettingBase;->modifyUserState(I)Landroid/content/pm/PackageUserState;
    ...
    .line 261
    iput-object p8, v0, Landroid/content/pm/PackageUserState;->guestHideComponents:Ljava/util/HashSet;
