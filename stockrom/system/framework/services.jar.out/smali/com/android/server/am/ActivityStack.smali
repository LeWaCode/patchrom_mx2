...
.field public static final CAMERA:Landroid/content/ComponentName; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ActivityStack;->CAMERA:Landroid/content/ComponentName;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 285
    iput-boolean v3, p0, Lcom/android/server/am/ActivityStack;->mNeedResume:Z
...
.method private final startPausingLocked(ZZ)V
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/android/server/wm/WindowManagerService;->setStatusBarBackgroundTransparent(Landroid/os/IBinder;ZZ)V
...
.method final ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    invoke-virtual {p0, p1, v4, v5, v3}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
    ...
    invoke-interface {v3, v6}, Landroid/app/IApplicationThread;->scheduleActivityConfigurationChanged(Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Landroid/os/ParcelFileDescriptor;I)Landroid/content/pm/ActivityInfo;
    ...
    .line 3244
    iget-object v1, v7, Landroid/content/pm/ComponentInfo;->processName:Ljava/lang/String;
    ...
    iget-object v2, v7, Landroid/content/pm/ComponentInfo;->processName:Ljava/lang/String;
    ...
    iget-object v3, v7, Landroid/content/pm/ComponentInfo;->processName:Ljava/lang/String;
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->isScreenRotationAnimating()Z
    ...
    const-string v4, "~~~~~Skip resume of top activity"
    ...
    const-string v4, " because screenrotation is animating"
    ...
    iput-boolean v2, v0, Lcom/android/server/am/ActivityStack;->mNeedResume:Z
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    invoke-virtual {v6, v3, v0, v1}, Landroid/app/AppOpsManager;->checkOpNoThrow(IILjava/lang/String;)I
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/app/AppOpsManager;->sendOperationBroadcast(IILjava/lang/String;IZ)V
    :try_end_1
    ...
    sget-object v3, Lcom/android/server/am/ActivityStack;->CAMERA:Landroid/content/ComponentName;
    ...
    .line 2675
    .local v31, isLockView:Z
    :goto_7
    and-int/lit8 v3, v26, 0x20
    ...
    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mAcm:Landroid/content/pm/AccessControlManager;
    ...
    iput-object v3, v0, Lcom/android/server/am/ActivityStack;->mAcm:Landroid/content/pm/AccessControlManager;

    .line 2680
    :cond_17
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/am/ActivityStack;->mIPm:Landroid/content/pm/IPackageManager;
    ...
    iput-object v3, v0, Lcom/android/server/am/ActivityStack;->mIPm:Landroid/content/pm/IPackageManager;
    ...
    iget-boolean v0, v0, Landroid/content/pm/ActivityInfo;->needAccessControl:Z
    ...
    invoke-interface {v3, v4, v8}, Landroid/content/pm/IPackageManager;->getPackageGuestSetting(Ljava/lang/String;I)Z
    :try_end_5
    ...
    .line 2705
    .local v35, mDisplaytitString:Ljava/lang/CharSequence;
    :goto_a
    move-object/from16 v0, p4
    ...
    .line 2706
    .local v34, mAccessPkg:Ljava/lang/String;
    if-eqz v40, :cond_22
    ...
    .end local v27           #hide:Z
    .end local v30           #isFastStarting:Z
    .end local v31           #isLockView:Z
    .end local v34           #mAccessPkg:Ljava/lang/String;
    .end local v35           #mDisplaytitString:Ljava/lang/CharSequence;
    .end local v37           #needAccessControl:Z
    ...
    .line 2675
    .restart local v31       #isLockView:Z
    :cond_20
    const/16 v30, 0x0
    ...
    .line 2702
    .restart local v27       #hide:Z
    .restart local v30       #isFastStarting:Z
    .restart local v37       #needAccessControl:Z
    ...
    .line 2706
    .restart local v34       #mAccessPkg:Ljava/lang/String;
    .restart local v35       #mDisplaytitString:Ljava/lang/CharSequence;
    :cond_22
    const/16 p4, 0x0
    ...
    invoke-virtual/range {v8 .. v13}, Lcom/android/server/am/ActivityStack;->startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IZLandroid/os/Bundle;)I
    ...
    iget-object v12, v3, Landroid/content/pm/ComponentInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
