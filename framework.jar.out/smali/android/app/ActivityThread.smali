...
.method getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Ljava/lang/String;Z)Landroid/content/res/Resources;
    ...
    iget-boolean v9, v5, Landroid/content/res/CompatibilityInfo;->isThemeable:Z

    invoke-virtual {v1, v9}, Landroid/content/res/AssetManager;->setThemeSupport(Z)V
    ...
    invoke-static {p0, v1, v5}, Landroid/app/ActivityThread$Injector;->attachTheme(Landroid/app/ActivityThread;Landroid/content/res/AssetManager;Landroid/content/res/CompatibilityInfo;)V
    ...
    :cond_5
    :goto_3
    new-instance v7, Landroid/content/res/LewaResources;

    .end local v7           #r:Landroid/content/res/Resources;
    move-object/from16 v0, p4

    invoke-direct {v7, v1, v3, v2, v0}, Landroid/content/res/LewaResources;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
