...
.field private mWifiApConnectRecordStore:Landroid/net/wifi/WifiApConnectRecordStore;
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    iget-object v0, v0, Landroid/net/wifi/WifiConfiguration;->HexSSID:Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Landroid/net/wifi/WifiConfigStore;->removeHex0X(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v0, v1, Landroid/net/wifi/WifiConfiguration;->HexSSID:Ljava/lang/String;
    ...
    const-string v25, "failed to set HexSSID: "
    ...
    .line 1216
    .end local v18           #savedNetId:Ljava/lang/Integer;
    .restart local v21       #updateFailed:Z
    :cond_3
    move-object/from16 v0, p1
    ...
    .line 1217
    .local v19, tempssid:Ljava/lang/String;
    invoke-static/range {v19 .. v19}, Landroid/net/wifi/WifiConfigStore;->str2HexStr(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1229
    .end local v19           #tempssid:Ljava/lang/String;
    :cond_4
    move-object/from16 v0, p1
    ...
    const-string/jumbo v25, "psk_key_type"
    ...
    const-string v25, ": failed to set WAPI_CERT index: "
    ...
    iput-object v0, v1, Landroid/net/wifi/WifiConfiguration;->preSharedKeyEncry:Ljava/lang/String;
    ...
    iput-object v0, v1, Landroid/net/wifi/WifiConfiguration;->wepKeyEncry:Ljava/lang/String;
    ...
    .line 1423
    .local v23, varName:Ljava/lang/String;
    ...
    .line 1438
    .local v20, tmpPassword:Ljava/lang/String;
    if-eqz v20, :cond_1d
    ...
    .line 1433
    .end local v20           #tmpPassword:Ljava/lang/String;
    :cond_1a
    move-object/from16 v0, p1
    ...
    .end local v23           #varName:Ljava/lang/String;
    :cond_1e
    const/16 v21, 0x0
...
.method private isPassWordChanged(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiConfiguration;)Z
    .locals 5
    .parameter "oldConfig"
    .parameter "newConfig"
    ...
    iget-object v4, p2, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;
...
.method private readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    iput-object v10, p1, Landroid/net/wifi/WifiConfiguration;->HexSSID:Ljava/lang/String;
    ...
    iput-object v10, p1, Landroid/net/wifi/WifiConfiguration;->wepKeyEncry:Ljava/lang/String;
    ...
    const-string/jumbo v11, "wepencry"
    ...
    .line 1684
    iput-object v9, p1, Landroid/net/wifi/WifiConfiguration;->wepKeyEncry:Ljava/lang/String;
    ...
    const-string/jumbo v11, "pskencry"
    ...
    .line 1702
    iput-object v9, p1, Landroid/net/wifi/WifiConfiguration;->preSharedKeyEncry:Ljava/lang/String;
    ...
    iput-object v10, p1, Landroid/net/wifi/WifiConfiguration;->preSharedKeyEncry:Ljava/lang/String;
    ...
    invoke-direct {p0, v10}, Landroid/net/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
...
.method private removeHex0X(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .parameter "string"
...
.method initialize()V
    ...
    .prologue
    .line 175
    const-string v9, "Loading config and enabling all networks"

    invoke-direct {p0, v9}, Landroid/net/wifi/WifiConfigStore;->log(Ljava/lang/String;)V
    ...
    .line 179
    :try_start_0
    new-instance v9, Landroid/net/wifi/WifiApConnectRecordStore;

    invoke-direct {v9}, Landroid/net/wifi/WifiApConnectRecordStore;-><init>()V

    iput-object v9, p0, Landroid/net/wifi/WifiConfigStore;->mWifiApConnectRecordStore:Landroid/net/wifi/WifiApConnectRecordStore;

    .line 181
    iget-object v9, p0, Landroid/net/wifi/WifiConfigStore;->mWifiApConnectRecordStore:Landroid/net/wifi/WifiApConnectRecordStore;

    iget-object v10, p0, Landroid/net/wifi/WifiConfigStore;->mConfiguredNetworks:Ljava/util/HashMap;

    invoke-virtual {v9, v10}, Landroid/net/wifi/WifiApConnectRecordStore;->syncWithSupplicantConf(Ljava/util/HashMap;)V

    .line 182
    iget-object v9, p0, Landroid/net/wifi/WifiConfigStore;->mWifiApConnectRecordStore:Landroid/net/wifi/WifiApConnectRecordStore;

    invoke-virtual {v9}, Landroid/net/wifi/WifiApConnectRecordStore;->getAndRemoveRedundantList()[I

    move-result-object v8

    .line 183
    .local v8, redundantList:[I
    if-eqz v8, :cond_1
    ...
    invoke-virtual {p0, v9}, Landroid/net/wifi/WifiConfigStore;->forgetNetwork(I)Z
    ...
    const-string/jumbo v10, "no exist node which is redundant and want to remove "
    ...
    const-string v10, "WifiApConnectRecordStore mgmt failed"
    ...
    .restart local v8       #redundantList:[I
    :cond_2
    :try_start_1
    invoke-static {v2}, Landroid/net/wifi/WifiConfigStore;->logDelete(Ljava/lang/String;)V
    :try_end_1
...
.method public removeRedundantConfig()V
    .locals 15
    ...
    .line 634
    .local v2, configuredNetworks:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Ljava/util/ArrayList<Landroid/net/wifi/WifiConfiguration;>;>;"
    iget-object v12, p0, Landroid/net/wifi/WifiConfigStore;->mConfiguredNetworks:Ljava/util/HashMap;
    ...
    .line 644
    .local v0, clist:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/wifi/WifiConfiguration;>;"
    :goto_1
    ...
    .line 641
    .end local v0           #clist:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/wifi/WifiConfiguration;>;"
    :cond_0
    ...
    .line 642
    .restart local v0       #clist:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/wifi/WifiConfiguration;>;"
    invoke-static {v7}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;
    ...
    .line 649
    .local v8, list:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/wifi/WifiConfiguration;>;"
    ...
    .line 654
    .local v4, enableIndex:I
    const/4 v11, 0x0

    .line 657
    .local v11, unremoveIndex:I
    const/4 v5, 0x0
    ...
    iget v10, v12, Landroid/net/wifi/WifiConfiguration;->status:I
    ...
    invoke-direct {p0, v12}, Landroid/net/wifi/WifiConfigStore;->log(Ljava/lang/String;)V

    .line 681
    iget v12, v1, Landroid/net/wifi/WifiConfiguration;->networkId:I

    invoke-virtual {p0, v12}, Landroid/net/wifi/WifiConfigStore;->forgetNetwork(I)Z
    ...
    .end local v4           #enableIndex:I
    .end local v5           #i:I
    .end local v8           #list:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/wifi/WifiConfiguration;>;"
    .end local v11           #unremoveIndex:I
    :cond_9
    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "remove count "
...
.method saveNetwork(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    .line 293
    :cond_0
    new-instance v4, Landroid/net/wifi/NetworkUpdateResult;

    invoke-direct {v4, v9}, Landroid/net/wifi/NetworkUpdateResult;-><init>(I)V
    ...
    invoke-direct {p0, v2, p1}, Landroid/net/wifi/WifiConfigStore;->isPassWordChanged(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiConfiguration;)Z
    ...
    .line 316
    .end local v2           #oldConfig:Landroid/net/wifi/WifiConfiguration;
    :cond_2
    invoke-direct {p0, p1}, Landroid/net/wifi/WifiConfigStore;->addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    invoke-virtual {v5, v0, v6}, Landroid/net/wifi/WifiNative;->enableNetwork(IZ)Z
    ...
    .end local v3           #passWordChanged:Z
    ...
    .restart local v3       #passWordChanged:Z
    .restart local v4       #result:Landroid/net/wifi/NetworkUpdateResult;
    :cond_5
    invoke-virtual {v4}, Landroid/net/wifi/NetworkUpdateResult;->isNewNetwork()Z
...
.method startWpsPbc(Landroid/net/wifi/WpsInfo;)Landroid/net/wifi/WpsResult;
    ...
    .line 597
    .local v5, oldConfigs:Ljava/util/List;,"Ljava/util/List<Landroid/net/wifi/WifiConfiguration;>;"
    new-instance v6, Landroid/net/wifi/WpsResult;

    invoke-direct {v6}, Landroid/net/wifi/WpsResult;-><init>()V

    .line 598
    .local v6, result:Landroid/net/wifi/WpsResult;
    iget-object v7, p0, Landroid/net/wifi/WifiConfigStore;->mWifiNative:Landroid/net/wifi/WifiNative;

    iget-object v8, p1, Landroid/net/wifi/WpsInfo;->BSSID:Ljava/lang/String;

    invoke-virtual {v7, v8}, Landroid/net/wifi/WifiNative;->startWpsPbc(Ljava/lang/String;)Z
    ...
    .line 602
    .local v3, nConf:Landroid/net/wifi/WifiConfiguration;
    ...
    .line 603
    .local v4, oConf:Landroid/net/wifi/WifiConfiguration;
    invoke-static {v4}, Landroid/net/wifi/WifiConfigStore;->configKey(Landroid/net/wifi/WifiConfiguration;)I

    move-result v7

    invoke-static {v3}, Landroid/net/wifi/WifiConfigStore;->configKey(Landroid/net/wifi/WifiConfiguration;)I
    ...
    .line 609
    .end local v4           #oConf:Landroid/net/wifi/WifiConfiguration;
    :cond_1
    if-nez v0, :cond_3
    ...
    const-string/jumbo v8, "wps_pbc: configuration update of network "
    ...
    invoke-virtual {p0, v7}, Landroid/net/wifi/WifiConfigStore;->selectNetwork(I)Z

    .line 619
    .end local v2           #i$:Ljava/util/Iterator;
    .end local v3           #nConf:Landroid/net/wifi/WifiConfiguration;
    :cond_2
    ...
    iput-object v7, v6, Landroid/net/wifi/WpsResult;->status:Landroid/net/wifi/WpsResult$Status;
    ...
    .restart local v3       #nConf:Landroid/net/wifi/WifiConfiguration;
    :cond_3
    const/4 v0, 0x0
    ...
    .end local v3           #nConf:Landroid/net/wifi/WifiConfiguration;
    :cond_4
    const-string v7, "Failed to start WPS push button configuration"

    invoke-direct {p0, v7}, Landroid/net/wifi/WifiConfigStore;->loge(Ljava/lang/String;)V
...
.method updateStatus(ILandroid/net/NetworkInfo$DetailedState;)V
    ...
    .restart local v0       #config:Landroid/net/wifi/WifiConfiguration;
    :cond_1
    sget-object v2, Landroid/net/wifi/WifiConfigStore$1;->$SwitchMap$android$net$NetworkInfo$DetailedState:[I
    ...
    .line 371
    iget-object v2, p0, Landroid/net/wifi/WifiConfigStore;->mWifiApConnectRecordStore:Landroid/net/wifi/WifiApConnectRecordStore;
    ...
    invoke-virtual {v2, v3, v4}, Landroid/net/wifi/WifiApConnectRecordStore;->addConnectRecordNode(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, Landroid/net/wifi/WifiConfigStore;->mWifiApConnectRecordStore:Landroid/net/wifi/WifiApConnectRecordStore;
