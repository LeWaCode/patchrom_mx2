...
.method constructor <init>(Landroid/widget/AbsListView;Landroid/view/View;ILandroid/widget/AbsListView$PerformClick;)V
    ...
    iput p3, p0, Landroid/widget/AbsListView$4;->val$motionPosition:I

    iput-object p4, p0, Landroid/widget/AbsListView$4;->val$performClick:Landroid/widget/AbsListView$PerformClick;
...
.method public run()V
    ...
    .line 3932
    iget-object v4, p0, Landroid/widget/AbsListView$4;->val$child:Landroid/view/View;
    ...
    iget v5, p0, Landroid/widget/AbsListView$4;->val$motionPosition:I
    ...
    invoke-static {v4, v5}, Landroid/widget/AbsListView;->access$1100(Landroid/widget/AbsListView;I)Z
    ...
    invoke-static {v4}, Landroid/widget/AbsListView;->access$1200(Landroid/widget/AbsListView;)Z
    ...
    iget v7, p0, Landroid/widget/AbsListView$4;->val$motionPosition:I
    ...
    iget v4, p0, Landroid/widget/AbsListView$4;->val$motionPosition:I
    ...
    invoke-virtual {v3, v4}, Landroid/widget/AbsListView;->isItemSelectable(I)Z
    ...
    .line 3952
    :cond_3
    iget-object v3, p0, Landroid/widget/AbsListView$4;->val$performClick:Landroid/widget/AbsListView$PerformClick;
