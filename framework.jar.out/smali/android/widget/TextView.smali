...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/widget/TextView$ShakeListener;,
        Landroid/widget/TextView$ShakeHolder;,
...
.field static final ID_COPY_ALL:I = 0x102026c
...
.field private mCleanComposing:Ljava/lang/Boolean;

.field private mClearText:Z
...
.field private mCursorIncludeLineSpacing:Ljava/lang/Boolean;
...
.field private mImagesClickable:Z

.field private mIncludeBottomLineSpacing:Ljava/lang/Boolean;
...
.field private mShakeAnimatorListener:Landroid/animation/Animator$AnimatorListener;

.field private mShakeAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

.field private mShakeHolder:Landroid/widget/TextView$ShakeHolder;

.field private mShakeListener:Landroid/widget/TextView$ShakeListener;
...
.field private mUrlLongPressPriority:Z

.field private mUserSetTextScaleX:Z

.field private mVoiceAnimSpan:Landroid/text/style/VoiceAnimSpan;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v0, v1, Landroid/widget/TextView;->mKeepSelection:Z
    ...
    iput-boolean v0, v1, Landroid/widget/TextView;->mImagesClickable:Z
    ...
    iput-boolean v0, v1, Landroid/widget/TextView;->mUrlLongPressPriority:Z
    ...
    iput-object v0, v1, Landroid/widget/TextView;->mIncludeBottomLineSpacing:Ljava/lang/Boolean;
    ...
    iput-object v0, v1, Landroid/widget/TextView;->mCursorIncludeLineSpacing:Ljava/lang/Boolean;
    ...
    iput-object v0, v1, Landroid/widget/TextView;->mCleanComposing:Ljava/lang/Boolean;
    ...
    iput-boolean v0, v1, Landroid/widget/TextView;->isShakeAnimating:Z
    ...
    iput v0, v1, Landroid/widget/TextView;->mRepeat:I
    ...
    iput v0, v1, Landroid/widget/TextView;->mDuration:I
    ...
    iput-boolean v0, v1, Landroid/widget/TextView;->mClearText:Z
    ...
    iput-object v0, v1, Landroid/widget/TextView;->mShakeListener:Landroid/widget/TextView$ShakeListener;

    .line 9508
    new-instance v62, Landroid/widget/TextView$5;
    ...
    iput-object v0, v1, Landroid/widget/TextView;->mShakeAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;

    .line 9517
    new-instance v62, Landroid/widget/TextView$6;
    ...
    iput-object v0, v1, Landroid/widget/TextView;->mShakeAnimatorListener:Landroid/animation/Animator$AnimatorListener;
    ...
    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setIncludeBottomLineSpacing(Z)V
...
.method static synthetic access$1302(Landroid/widget/TextView;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 226
    iput-boolean p1, p0, Landroid/widget/TextView;->isShakeAnimating:Z

    return p1
.end method

.method static synthetic access$1400(Landroid/widget/TextView;)Landroid/widget/TextView$ShakeListener;
    .locals 1
    .parameter "x0"

    .prologue
    .line 226
    iget-object v0, p0, Landroid/widget/TextView;->mShakeListener:Landroid/widget/TextView$ShakeListener;
...
.method static synthetic access$1500(Landroid/widget/TextView;)Z
    ...
    .prologue
    .line 226
    iget-boolean v0, p0, Landroid/widget/TextView;->mClearText:Z
...
.method private cancelImageState()V
    .locals 9
    ...
    const-class v7, Landroid/text/style/ClickableImageSpan;

    invoke-interface {v1, v8, v6, v7}, Landroid/text/Spannable;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;

    move-result-object v4

    check-cast v4, [Landroid/text/style/ClickableImageSpan;

    .line 7779
    .local v4, imageSpanMZs:[Landroid/text/style/ClickableImageSpan;
    array-length v6, v4
    ...
    .local v0, arr$:[Landroid/text/style/ClickableImageSpan;
    array-length v5, v0
    ...
    .line 7781
    .local v3, imageSpanMZ:Landroid/text/style/ClickableImageSpan;
    invoke-virtual {v3, v8, p0}, Landroid/text/style/ClickableImageSpan;->updateActionButtonState(ZLandroid/widget/TextView;)V
    ...
    .line 7784
    .end local v0           #arr$:[Landroid/text/style/ClickableImageSpan;
    .end local v2           #i$:I
    .end local v3           #imageSpanMZ:Landroid/text/style/ClickableImageSpan;
    .end local v5           #len$:I
    :cond_0
    return-void
.end method
...
.method private createShakeAnimation()V
    .locals 6
    ...
    .line 9492
    iget-object v2, p0, Landroid/widget/TextView;->mShakeAnim:Landroid/animation/AnimatorSet;

    if-nez v2, :cond_0

    .line 9494
    new-instance v2, Landroid/widget/TextView$ShakeHolder;

    invoke-direct {v2, p0}, Landroid/widget/TextView$ShakeHolder;-><init>(Landroid/widget/TextView;)V

    iput-object v2, p0, Landroid/widget/TextView;->mShakeHolder:Landroid/widget/TextView$ShakeHolder;
    ...
    .line 9496
    .local v1, shakeXHolder:Landroid/animation/PropertyValuesHolder;
    iget-object v2, p0, Landroid/widget/TextView;->mShakeHolder:Landroid/widget/TextView$ShakeHolder;
    ...
    .line 9497
    .local v0, shakeAnimator:Landroid/animation/ObjectAnimator;
    iget v2, p0, Landroid/widget/TextView;->mDuration:I
    ...
    .line 9498
    iget v2, p0, Landroid/widget/TextView;->mRepeat:I
    ...
    .line 9500
    iget-object v2, p0, Landroid/widget/TextView;->mShakeAnimatorUpdateListener:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iput-object v2, p0, Landroid/widget/TextView;->mShakeAnim:Landroid/animation/AnimatorSet;

    .line 9503
    iget-object v2, p0, Landroid/widget/TextView;->mShakeAnim:Landroid/animation/AnimatorSet;

    iget-object v3, p0, Landroid/widget/TextView;->mShakeAnimatorListener:Landroid/animation/Animator$AnimatorListener;
    ...
    .line 9506
    .end local v0           #shakeAnimator:Landroid/animation/ObjectAnimator;
    .end local v1           #shakeXHolder:Landroid/animation/PropertyValuesHolder;
    :cond_0
    return-void
...
.method private createVoiceAnimSpan()Landroid/text/style/VoiceAnimSpan;
    .locals 3

    .prologue
    .line 9081
    iget-object v0, p0, Landroid/widget/TextView;->mVoiceAnimSpan:Landroid/text/style/VoiceAnimSpan;

    if-nez v0, :cond_0

    .line 9082
    new-instance v0, Landroid/text/style/VoiceAnimSpan;
    ...
    invoke-direct {v0, v1, v2}, Landroid/text/style/VoiceAnimSpan;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroid/widget/TextView;->mVoiceAnimSpan:Landroid/text/style/VoiceAnimSpan;

    .line 9083
    iget-object v0, p0, Landroid/widget/TextView;->mVoiceAnimSpan:Landroid/text/style/VoiceAnimSpan;

    invoke-virtual {v0, p0}, Landroid/text/style/VoiceAnimSpan;->setTextView(Landroid/widget/TextView;)V

    .line 9084
    iget-object v0, p0, Landroid/widget/TextView;->mVoiceAnimSpan:Landroid/text/style/VoiceAnimSpan;

    invoke-virtual {v0}, Landroid/text/style/VoiceAnimSpan;->reset()V
...
.method private performTouchToImage(Landroid/view/MotionEvent;)V
    .locals 8
    .parameter "event"
    ...
    invoke-virtual {v2, v3, v7}, Landroid/text/Layout;->getOffsetForHorizontal(IF)I
    ...
    check-cast v1, [Landroid/text/style/ClickableImageSpan;

    .line 7809
    .local v1, imageSpanMZs:[Landroid/text/style/ClickableImageSpan;
    array-length v7, v1
    ...
    invoke-virtual {v7, p1, v0, p0}, Landroid/text/style/ClickableImageSpan;->onClick(Landroid/view/MotionEvent;Landroid/text/Spannable;Landroid/widget/TextView;)Z

    .line 7813
    .end local v0           #buffer:Landroid/text/Spannable;
    .end local v1           #imageSpanMZs:[Landroid/text/style/ClickableImageSpan;
...
.method private removeComposingSpan()Ljava/lang/CharSequence;
    .locals 9
    ...
    .line 1335
    .local v2, dstr:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Landroid/widget/TextView;->mCleanComposing:Ljava/lang/Boolean;
    ...
    invoke-interface {v4, v8, v1}, Landroid/text/Spannable;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-interface {v4, v0, v7}, Landroid/text/Spannable;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, Lcom/android/internal/widget/EditableInputConnection;->getVoicingSpanStart(Landroid/text/Spannable;)I

    move-result v5

    .line 1352
    .local v5, start:I
    invoke-static {v4}, Lcom/android/internal/widget/EditableInputConnection;->getVoicingSpanEnd(Landroid/text/Spannable;)I
    ...
    invoke-interface {v4, v8, v5}, Landroid/text/Spannable;->subSequence(II)Ljava/lang/CharSequence;
    ...
    invoke-interface {v4, v3, v7}, Landroid/text/Spannable;->subSequence(II)Ljava/lang/CharSequence;
...
.method private setText(Ljava/lang/CharSequence;Landroid/widget/TextView$BufferType;ZI)V
    ...
    iget-boolean v4, v0, Landroid/widget/TextView;->mAutoLinkMaskIncludeDateTime:Z
    ...
    iput v4, v0, Landroid/widget/TextView;->mAutoLinkMask:I
...
.method private shakeVoiceAnim(Z)V
    .locals 1
    .parameter "shake"
    ...
    invoke-virtual {v0, p1}, Landroid/text/style/VoiceAnimSpan;->setShake(Z)V
...
.method private showVoiceAnim()V
    .locals 8
    ...
    invoke-direct {p0}, Landroid/widget/TextView;->createVoiceAnimSpan()Landroid/text/style/VoiceAnimSpan;

    move-result-object v2

    .local v2, loadingSpan:Landroid/text/style/VoiceAnimSpan;
    ...
    :cond_0
    invoke-virtual {v2}, Landroid/text/style/VoiceAnimSpan;->reset()V

    new-instance v3, Landroid/text/SpannableString;

    const-string v5, "Voice_Loading"
    ...
    invoke-virtual {v3, v2, v5, v6, v7}, Landroid/text/SpannableString;->setSpan(Ljava/lang/Object;III)V
...
.method public bringPointIntoView(I)Z
    ...
    .local v14, ht:I
    sget-object v24, Landroid/widget/TextView$7;->$SwitchMap$android$text$Layout$Alignment:[I
...
.method public getCursorIncludeLineSpacing()Z
    .locals 1

    .prologue
    iget-object v0, p0, Landroid/widget/TextView;->mCursorIncludeLineSpacing:Ljava/lang/Boolean;
...
.method public getTextWithoutComposingText()Ljava/lang/CharSequence;
    .locals 1

    .prologue
    invoke-direct {p0}, Landroid/widget/TextView;->removeComposingSpan()Ljava/lang/CharSequence;
...
.method public final hideVoiceAnim(Ljava/lang/CharSequence;)V
    .locals 5
    .parameter "text"
    ...
    .local v0, editable:Landroid/text/Editable;
    iget-object v3, p0, Landroid/widget/TextView;->mVoiceAnimSpan:Landroid/text/style/VoiceAnimSpan;
    ...
    invoke-virtual {v3, v4}, Landroid/text/style/VoiceAnimSpan;->setShake(Z)V
...
.method public invalidateTextDisplayList(II)V
    .locals 2
    .parameter "start"
    .parameter "end"
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v2, v0, Landroid/widget/TextView;->isShakeAnimating:Z
    ...
    iget-object v2, v0, Landroid/widget/TextView;->mShakeHolder:Landroid/widget/TextView$ShakeHolder;

    invoke-virtual {v2}, Landroid/widget/TextView$ShakeHolder;->getTranslateX()F
    ...
    .end local v24           #hspace:I
    .end local v36           #vspace:I
    :cond_4
    move-object/from16 v0, p0
    ...
    .local v23, extendedPaddingTop:I
    invoke-virtual/range {p0 .. p0}, Landroid/widget/TextView;->getExtendedPaddingBottom()I

    move-result v22

    .local v22, extendedPaddingBottom:I
    move-object/from16 v0, p0
    ...
    .end local v22           #extendedPaddingBottom:I
    :cond_8
    sub-int v2, v2, v22
    ...
    .local v35, voffsetText:I
    const/16 v34, 0x0

    .local v34, voffsetCursor:I
    move-object/from16 v0, p0
    ...
    .end local v34           #voffsetCursor:I
    .end local v35           #voffsetText:I
    .restart local v22       #extendedPaddingBottom:I
    :cond_11
    add-int v2, v23, v32
    ...
    .restart local v34       #voffsetCursor:I
    .restart local v35       #voffsetText:I
    :cond_12
    move-object/from16 v0, p0
...
.method public onPrivateIMECommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    const-string v4, "clearComposingTextOnFinish"
    ...
    iput-object v4, p0, Landroid/widget/TextView;->mCleanComposing:Ljava/lang/Boolean;
    ...
    const-string v4, "com.meizu.input.textviewVoiceAnimHide"
    ...
    const-string v4, "com.meizu.input.textviewVoiceAnimShake"
    ...
    const-string v4, "com.meizu.input.textviewVoiceAnimShow"
    ...
    invoke-interface {v0, v2, v4, v1}, Landroid/text/Editable;->replace(IILjava/lang/CharSequence;)Landroid/text/Editable;
    ...
    invoke-direct {p0}, Landroid/widget/TextView;->showVoiceAnim()V
    ...
    invoke-direct {p0, v3}, Landroid/widget/TextView;->shakeVoiceAnim(Z)V
    ...
    :goto_3
    invoke-virtual {p0, v1}, Landroid/widget/TextView;->hideVoiceAnim(Ljava/lang/CharSequence;)V
...
.method public onTextContextMenuItem(I)Z
    ...
    invoke-direct {p0, v5}, Landroid/widget/TextView;->showToastTip(Ljava/lang/String;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v8, p0, Landroid/widget/TextView;->mImagesClickable:Z

    if-eqz v8, :cond_0

    invoke-direct {p0, p1}, Landroid/widget/TextView;->performTouchToImage(Landroid/view/MotionEvent;)V
    ...
    invoke-direct {p0}, Landroid/widget/TextView;->cancelImageState()V
...
.method public performLongClick()Z
    ...
    .local v0, handled:Z
    iget-boolean v4, p0, Landroid/widget/TextView;->mUrlLongPressPriority:Z
    ...
    iget v4, v4, Landroid/widget/Editor;->mLastDownPositionX:F

    iget-object v5, p0, Landroid/widget/TextView;->mEditor:Landroid/widget/Editor;

    iget v5, v5, Landroid/widget/Editor;->mLastDownPositionY:F
    ...
    invoke-virtual {v4, p0}, Landroid/text/style/ClickableSpan;->onLongClick(Landroid/view/View;)Z
    ...
    iput-boolean v9, v4, Landroid/widget/Editor;->mDiscardNextActionUp:Z
    ...
    .restart local v2       #links:[Landroid/text/style/ClickableSpan;
    array-length v4, v2
...
.method public setCursorIncludeLineSpacing(Z)V
    .locals 1
    .parameter "value"
    ...
    iput-object v0, p0, Landroid/widget/TextView;->mCursorIncludeLineSpacing:Ljava/lang/Boolean;
...
.method public setImagesClickable(Z)V
    .locals 0
    .parameter "enabled"

    .prologue
    iput-boolean p1, p0, Landroid/widget/TextView;->mImagesClickable:Z
...
.method public setIncludeBottomLineSpacing(Z)V
    .locals 2
    .parameter "value"
    ...
    iput-object v0, p0, Landroid/widget/TextView;->mIncludeBottomLineSpacing:Ljava/lang/Boolean;

    iget-object v0, p0, Landroid/widget/TextView;->mTextPaint:Landroid/text/TextPaint;

    iget-object v1, p0, Landroid/widget/TextView;->mIncludeBottomLineSpacing:Ljava/lang/Boolean;

    invoke-virtual {v1}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v1

    iput-boolean v1, v0, Landroid/text/TextPaint;->mIncludeBottomLineSpacing:Z
...
.method public setKeepSelection(Z)V
    ...
    .prologue
    iput-boolean p1, p0, Landroid/widget/TextView;->mKeepSelection:Z
    ...
    invoke-virtual {v0, p1}, Landroid/widget/Editor;->setKeepSelection(Z)V
...
.method public setUrlLongPressPriority(Z)V
    .locals 0
    .parameter "priority"

    .prologue
    iput-boolean p1, p0, Landroid/widget/TextView;->mUrlLongPressPriority:Z
...
.method public shakeContent(ZLandroid/widget/TextView$ShakeListener;)V
    .locals 1
    .parameter "clearText"
    .parameter "listener"

    .prologue
    iget-boolean v0, p0, Landroid/widget/TextView;->isShakeAnimating:Z
    ...
    :cond_1
    invoke-direct {p0}, Landroid/widget/TextView;->createShakeAnimation()V

    iget-object v0, p0, Landroid/widget/TextView;->mShakeAnim:Landroid/animation/AnimatorSet;

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/widget/TextView;->isShakeAnimating:Z

    iget-object v0, p0, Landroid/widget/TextView;->mShakeAnim:Landroid/animation/AnimatorSet;

    invoke-virtual {v0}, Landroid/animation/AnimatorSet;->start()V

    iput-boolean p1, p0, Landroid/widget/TextView;->mClearText:Z

    iput-object p2, p0, Landroid/widget/TextView;->mShakeListener:Landroid/widget/TextView$ShakeListener;
