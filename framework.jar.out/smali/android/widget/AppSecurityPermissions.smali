...
# instance fields
.field public mAllPermList:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/widget/AppSecurityPermissions;->mAllPermList:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/PackageInfo;)V
    ...
    iput-object v6, p0, Landroid/widget/AppSecurityPermissions;->mAllPermList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v4, v3}, Landroid/widget/AppSecurityPermissions;->getAllUsedPermissions(ILjava/util/Set;)V
    :try_end_1
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Landroid/widget/AppSecurityPermissions;->mAllPermList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v5, v2}, Landroid/widget/AppSecurityPermissions;->getAllUsedPermissions(ILjava/util/Set;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPermGroups:Ljava/util/Map;
    ...
    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPermGroupsList:Ljava/util/List;
    ...
    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mAllPermList:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPm:Landroid/content/pm/PackageManager;

    .line 254
    invoke-direct {p0}, Landroid/widget/AppSecurityPermissions;->loadResources()V

    .line 255
    new-instance v3, Landroid/widget/AppSecurityPermissions$PermissionInfoComparator;

    invoke-direct {v3}, Landroid/widget/AppSecurityPermissions$PermissionInfoComparator;-><init>()V

    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPermComparator:Landroid/widget/AppSecurityPermissions$PermissionInfoComparator;

    .line 256
    new-instance v3, Landroid/widget/AppSecurityPermissions$PermissionGroupInfoComparator;

    invoke-direct {v3}, Landroid/widget/AppSecurityPermissions$PermissionGroupInfoComparator;-><init>()V

    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPermGroupComparator:Landroid/widget/AppSecurityPermissions$PermissionGroupInfoComparator;
    ...
    iput-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPermsList:Ljava/util/List;
    ...
    invoke-direct {p0, v1, p2}, Landroid/widget/AppSecurityPermissions;->extractPermsOld(Ljava/util/Set;Ljava/util/List;)V
    ...
    .line 261
    .local v2, tmpInfo:Landroid/widget/AppSecurityPermissions$MyPermissionInfo;
    ...
    .line 263
    .end local v2           #tmpInfo:Landroid/widget/AppSecurityPermissions$MyPermissionInfo;
    :cond_0
    iget-object v3, p0, Landroid/widget/AppSecurityPermissions;->mPermsList:Ljava/util/List;
...
.method private displayPermissions(Ljava/util/List;Landroid/widget/LinearLayout;I)V
    ...
    invoke-direct {p0, v0, v4, v8, v9}, Landroid/widget/AppSecurityPermissions;->getPermissionItemView(Landroid/widget/AppSecurityPermissions$MyPermissionGroupInfo;Landroid/widget/AppSecurityPermissions$MyPermissionInfo;ZLjava/lang/CharSequence;)Landroid/widget/AppSecurityPermissions$PermissionItemView;
...
.method private extractPermsOld(Ljava/util/Set;Ljava/util/List;)V
    .locals 17
    .parameter
    .parameter
    .annotation system Ldalvik/annotation/Signature;
    ...
    .prologue
    .line 479
    .local p1, permSet:Ljava/util/Set;,"Ljava/util/Set<Landroid/widget/AppSecurityPermissions$MyPermissionInfo;>;"
    .local p2, permList:Ljava/util/List;,"Ljava/util/List<Landroid/content/pm/PermissionInfo;>;"
    ...
    .line 481
    .local v11, permissionInfo:Landroid/content/pm/PermissionInfo;
    ...
    .line 483
    .end local v11           #permissionInfo:Landroid/content/pm/PermissionInfo;
    :cond_0
    ...
    .line 484
    .local v12, strList:[Ljava/lang/String;
    ...
    iget-object v14, v0, Landroid/widget/AppSecurityPermissions;->mPm:Landroid/content/pm/PackageManager;
    ...
    .line 492
    .local v13, tmpPermInfo:Landroid/content/pm/PermissionInfo;
    if-nez v13, :cond_3

    .line 488
    .end local v13           #tmpPermInfo:Landroid/content/pm/PermissionInfo;
    :goto_2
    ...
    .line 495
    .restart local v13       #tmpPermInfo:Landroid/content/pm/PermissionInfo;
    :cond_3
    iget-object v9, v13, Landroid/content/pm/PermissionInfo;->group:Ljava/lang/String;

    .line 496
    .local v9, origGroupName:Ljava/lang/String;
    move-object v3, v9
    ...
    .line 499
    iput-object v3, v13, Landroid/content/pm/PermissionInfo;->group:Ljava/lang/String;

    .line 501
    :cond_4
    move-object/from16 v0, p0

    iget-object v14, v0, Landroid/widget/AppSecurityPermissions;->mPermGroups:Ljava/util/Map;
    ...
    .line 504
    .local v4, grp:Landroid/content/pm/PermissionGroupInfo;
    if-eqz v9, :cond_5
    ...
    invoke-virtual {v14, v9, v15}, Landroid/content/pm/PackageManager;->getPermissionGroupInfo(Ljava/lang/String;I)Landroid/content/pm/PermissionGroupInfo;
    ...
    invoke-direct {v2, v4}, Landroid/widget/AppSecurityPermissions$MyPermissionGroupInfo;-><init>(Landroid/content/pm/PermissionGroupInfo;)V
    ...
    iget-object v15, v13, Landroid/content/pm/PermissionInfo;->group:Ljava/lang/String;

    invoke-interface {v14, v15, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 524
    .end local v4           #grp:Landroid/content/pm/PermissionGroupInfo;
    :cond_6
    new-instance v8, Landroid/widget/AppSecurityPermissions$MyPermissionInfo;

    invoke-direct {v8, v13}, Landroid/widget/AppSecurityPermissions$MyPermissionInfo;-><init>(Landroid/content/pm/PermissionInfo;)V

    .line 525
    .local v8, myPerm:Landroid/widget/AppSecurityPermissions$MyPermissionInfo;
    move-object/from16 v0, p1
    ...
    .end local v8           #myPerm:Landroid/widget/AppSecurityPermissions$MyPermissionInfo;
    .end local v9           #origGroupName:Ljava/lang/String;
    .end local v13           #tmpPermInfo:Landroid/content/pm/PermissionInfo;
    :catch_0
    move-exception v1
    ...
    const-string v14, "AppSecurityPermissions"

    new-instance v15, Ljava/lang/StringBuilder;

    invoke-direct {v15}, Ljava/lang/StringBuilder;-><init>()V

    const-string v16, "Ignoring unknown permission:"
    ...
    .restart local v4       #grp:Landroid/content/pm/PermissionGroupInfo;
    .restart local v9       #origGroupName:Ljava/lang/String;
    .restart local v13       #tmpPermInfo:Landroid/content/pm/PermissionInfo;
    :cond_7
    :try_start_1
    iget-object v14, v13, Landroid/content/pm/PackageItemInfo;->packageName:Ljava/lang/String;

    iput-object v14, v13, Landroid/content/pm/PermissionInfo;->group:Ljava/lang/String;
    ...
    .end local v2           #group:Landroid/widget/AppSecurityPermissions$MyPermissionGroupInfo;
    invoke-direct {v2, v13}, Landroid/widget/AppSecurityPermissions$MyPermissionGroupInfo;-><init>(Landroid/content/pm/PermissionInfo;)V
...
.method private setPermissions(Ljava/util/List;)V
    ...
    .line 708
    iget-object v6, p0, Landroid/widget/AppSecurityPermissions;->mAllPermList:Ljava/util/ArrayList;
...
# virtual methods
.method public getAllUsedPermissions(ILjava/util/Set;)V
    .locals 6
    .parameter "sharedUid"
    .parameter
    .annotation system Ldalvik/annotation/Signature;
...
.method public getmPermsList()Ljava/util/ArrayList;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 82
    iget-object v0, p0, Landroid/widget/AppSecurityPermissions;->mAllPermList:Ljava/util/ArrayList;
