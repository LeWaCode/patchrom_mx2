...
.field private mExpandTouchWidth:I
...
.method constructor <init>()V
    ...
    iput v2, p0, Landroid/view/View;->mExpandTouchWidth:I
...
.method private pointInView(FFF)Z
    ...
    .line 9874
    iget v2, p0, Landroid/view/View;->mExpandTouchWidth:I
    ...
    iget v3, p0, Landroid/view/View;->mExpandTouchWidth:I
...
.method public expandTouchWidth(I)V
    .locals 1
    .parameter "width"
    ...
    iput v0, p0, Landroid/view/View;->mExpandTouchWidth:I

    .line 18902
    if-lez p1, :cond_0

    .line 18903
    iput p1, p0, Landroid/view/View;->mExpandTouchWidth:I
...
.method public getLocationInParent([ILandroid/view/ViewGroup;)V
    .locals 9
    .parameter "location"
    .parameter "parent"
...
.method public getRootWindowSession()Landroid/view/IWindowSession;
    .locals 1
...
.method public getWindow()Landroid/view/IWindow;
    ...
    iget-object v0, v0, Landroid/view/View$AttachInfo;->mWindow:Landroid/view/IWindow;
...
.method public notifyStatusBarNfcShareEnabled(ZZ)V
    ...
    invoke-virtual {v1, p1}, Landroid/view/ViewRootImpl;->setStatusBarNfcShareEnabled(Z)V
...
.method public setTransformDirectly(FFFF)V
    .locals 11
    .parameter "x"
    .parameter "y"
    .parameter "sx"
    ...
    .line 18730
    iget-object v9, p0, Landroid/view/View;->mTransformationInfo:Landroid/view/View$TransformationInfo;

    .line 18731
    .local v9, info:Landroid/view/View$TransformationInfo;
    iget v0, v9, Landroid/view/View$TransformationInfo;->mTranslationX:F

    cmpl-float v0, v0, p1

    if-nez v0, :cond_0

    iget v0, v9, Landroid/view/View$TransformationInfo;->mTranslationY:F

    cmpl-float v0, v0, p2

    if-nez v0, :cond_0

    iget v0, v9, Landroid/view/View$TransformationInfo;->mScaleX:F

    cmpl-float v0, v0, p3

    if-nez v0, :cond_0

    iget v0, v9, Landroid/view/View$TransformationInfo;->mScaleY:F
    ...
    .line 18734
    iput p1, v9, Landroid/view/View$TransformationInfo;->mTranslationX:F

    .line 18735
    iput p2, v9, Landroid/view/View$TransformationInfo;->mTranslationY:F

    .line 18736
    iput p3, v9, Landroid/view/View$TransformationInfo;->mScaleX:F

    .line 18737
    iput p4, v9, Landroid/view/View$TransformationInfo;->mScaleY:F

    .line 18738
    iput-boolean v1, v9, Landroid/view/View$TransformationInfo;->mMatrixDirty:Z
    ...
    iget v1, v9, Landroid/view/View$TransformationInfo;->mAlpha:F

    iget v2, v9, Landroid/view/View$TransformationInfo;->mTranslationX:F

    iget v3, v9, Landroid/view/View$TransformationInfo;->mTranslationY:F

    iget v4, v9, Landroid/view/View$TransformationInfo;->mRotation:F

    iget v5, v9, Landroid/view/View$TransformationInfo;->mRotationX:F

    iget v6, v9, Landroid/view/View$TransformationInfo;->mRotationY:F

    iget v7, v9, Landroid/view/View$TransformationInfo;->mScaleX:F

    iget v8, v9, Landroid/view/View$TransformationInfo;->mScaleY:F
...
.method public setXTranslationFraction(F)V
    .locals 3
    .parameter "xTranslationFraction"
...
.method public final startDragMz(Landroid/content/ClipData;Landroid/view/View$DragShadowBuilder;Ljava/lang/Object;I)Z
    ...
    invoke-virtual {v0, v1}, Landroid/view/ViewRootImpl;->setDragTouchState(Landroid/graphics/Point;)V
